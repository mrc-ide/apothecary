...
SEXP deterministic_apothecary_SEIR_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 832));
  ...
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_prob_hosp));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_get_ox));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_get_ox_baseline));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_get_ox_Drug_11));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_no_ox));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_no_ox_baseline));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_no_ox_Drug_11));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_prob_moderate_death_no_hosp_no_ox));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_prob_severe));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_prob_severe_death_get_ICU_get_ox));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_prob_severe_death_get_ICU_get_ox_baseline));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_prob_severe_death_get_ICU_get_ox_Drug_12));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_prob_severe_death_get_ICU_no_ox));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_prob_severe_death_get_ICU_no_ox_baseline));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_prob_severe_death_get_ICU_no_ox_Drug_12));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_prob_severe_death_no_ICU_no_ox));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_prop_ox_hosp_beds));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_prop_ox_ICU_beds));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_PS));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_PS_0));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_R));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_R_0));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_S_0));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_s_ij));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_s_ij_1));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_s_ij_2));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_temp));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_test_number_req_Hosp));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_tt_beta));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_tt_hosp_beds));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_tt_ICU_beds));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_tt_matrix));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_tt_prop_ox_hosp_beds));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_tt_prop_ox_ICU_beds));
  SET_VECTOR_ELT(contents, 299, ScalarReal(internal->drug_1_effect_size));
  SET_VECTOR_ELT(contents, 300, ScalarReal(internal->drug_1_indic));
  SET_VECTOR_ELT(contents, 301, ScalarReal(internal->drug_10_GetOx_GetMV_effect_size));
  SET_VECTOR_ELT(contents, 302, ScalarReal(internal->drug_10_GetOx_NoMV_effect_size));
  SET_VECTOR_ELT(contents, 303, ScalarReal(internal->drug_10_indic_ICrit_GetICU_GetOx_GetMV));
  SET_VECTOR_ELT(contents, 304, ScalarReal(internal->drug_10_indic_ICrit_GetICU_GetOx_NoMV));
  SET_VECTOR_ELT(contents, 305, ScalarReal(internal->drug_10_indic_ICrit_GetICU_NoOx_NoMV));
  SET_VECTOR_ELT(contents, 306, ScalarReal(internal->drug_10_NoOx_NoMV_effect_size));
  SET_VECTOR_ELT(contents, 307, ScalarReal(internal->drug_10_prop_treat));
  SET_VECTOR_ELT(contents, 308, ScalarReal(internal->drug_11_GetOx_effect_size));
  SET_VECTOR_ELT(contents, 309, ScalarReal(internal->drug_11_indic_IMod_GetHosp_GetOx));
  SET_VECTOR_ELT(contents, 310, ScalarReal(internal->drug_11_indic_IMod_GetHosp_NoOx));
  SET_VECTOR_ELT(contents, 311, ScalarReal(internal->drug_11_NoOx_effect_size));
  SET_VECTOR_ELT(contents, 312, ScalarReal(internal->drug_11_prop_treat));
  SET_VECTOR_ELT(contents, 313, ScalarReal(internal->drug_12_GetOx_effect_size));
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->drug_12_indic_ISev_GetICU_GetOx));
  SET_VECTOR_ELT(contents, 315, ScalarReal(internal->drug_12_indic_ISev_GetICU_NoOx));
  SET_VECTOR_ELT(contents, 316, ScalarReal(internal->drug_12_NoOx_effect_size));
  SET_VECTOR_ELT(contents, 317, ScalarReal(internal->drug_12_prop_treat));
  SET_VECTOR_ELT(contents, 318, ScalarReal(internal->drug_13_GetOx_GetMV_effect_size));
  SET_VECTOR_ELT(contents, 319, ScalarReal(internal->drug_13_GetOx_NoMV_effect_size));
  SET_VECTOR_ELT(contents, 320, ScalarReal(internal->drug_13_indic_ICrit_GetICU_GetOx_GetMV));
  SET_VECTOR_ELT(contents, 321, ScalarReal(internal->drug_13_indic_ICrit_GetICU_GetOx_NoMV));
  SET_VECTOR_ELT(contents, 322, ScalarReal(internal->drug_13_indic_ICrit_GetICU_NoOx_NoMV));
  SET_VECTOR_ELT(contents, 323, ScalarReal(internal->drug_13_NoOx_NoMV_effect_size));
  SET_VECTOR_ELT(contents, 324, ScalarReal(internal->drug_13_prop_treat));
  SET_VECTOR_ELT(contents, 325, ScalarReal(internal->drug_2_effect_size_IPreAsymp));
  SET_VECTOR_ELT(contents, 326, ScalarReal(internal->drug_2_effect_size_IPreCase));
  SET_VECTOR_ELT(contents, 327, ScalarReal(internal->drug_2_effect_size_IPreMild));
  SET_VECTOR_ELT(contents, 328, ScalarReal(internal->drug_2_indic_IPreAsymp));
  SET_VECTOR_ELT(contents, 329, ScalarReal(internal->drug_2_indic_IPreCase));
  SET_VECTOR_ELT(contents, 330, ScalarReal(internal->drug_2_indic_IPreMild));
  SET_VECTOR_ELT(contents, 331, ScalarReal(internal->drug_2_prop_treat));
  SET_VECTOR_ELT(contents, 332, ScalarReal(internal->drug_3_effect_size));
  SET_VECTOR_ELT(contents, 333, ScalarReal(internal->drug_3_indic));
  SET_VECTOR_ELT(contents, 334, ScalarReal(internal->drug_3_prop_treat));
  SET_VECTOR_ELT(contents, 335, ScalarReal(internal->drug_4_effect_size_IAsymp));
  SET_VECTOR_ELT(contents, 336, ScalarReal(internal->drug_4_effect_size_ICase));
  SET_VECTOR_ELT(contents, 337, ScalarReal(internal->drug_4_effect_size_IMild));
  SET_VECTOR_ELT(contents, 338, ScalarReal(internal->drug_4_indic_IAsymp));
  SET_VECTOR_ELT(contents, 339, ScalarReal(internal->drug_4_indic_ICase));
  SET_VECTOR_ELT(contents, 340, ScalarReal(internal->drug_4_indic_IMild));
  SET_VECTOR_ELT(contents, 341, ScalarReal(internal->drug_4_prop_treat));
  SET_VECTOR_ELT(contents, 342, ScalarReal(internal->drug_5_effect_size));
  SET_VECTOR_ELT(contents, 343, ScalarReal(internal->drug_5_indic_ICase));
  SET_VECTOR_ELT(contents, 344, ScalarReal(internal->drug_5_indic_IMild));
  SET_VECTOR_ELT(contents, 345, ScalarReal(internal->drug_5_prop_treat));
  SET_VECTOR_ELT(contents, 346, ScalarReal(internal->drug_6_effect_size));
  SET_VECTOR_ELT(contents, 347, ScalarReal(internal->drug_6_indic));
  SET_VECTOR_ELT(contents, 348, ScalarReal(internal->drug_6_prop_treat));
  SET_VECTOR_ELT(contents, 349, ScalarReal(internal->drug_7_effect_size));
  SET_VECTOR_ELT(contents, 350, ScalarReal(internal->drug_7_indic));
  SET_VECTOR_ELT(contents, 351, ScalarReal(internal->drug_7_prop_treat));
  SET_VECTOR_ELT(contents, 352, ScalarReal(internal->drug_8_GetOx_effect_size));
  SET_VECTOR_ELT(contents, 353, ScalarReal(internal->drug_8_indic_IMod_GetHosp_GetOx));
  SET_VECTOR_ELT(contents, 354, ScalarReal(internal->drug_8_indic_IMod_GetHosp_NoOx));
  SET_VECTOR_ELT(contents, 355, ScalarReal(internal->drug_8_NoOx_effect_size));
  SET_VECTOR_ELT(contents, 356, ScalarReal(internal->drug_8_prop_treat));
  SET_VECTOR_ELT(contents, 357, ScalarReal(internal->drug_9_GetOx_effect_size));
  SET_VECTOR_ELT(contents, 358, ScalarReal(internal->drug_9_indic_ISev_GetICU_GetOx));
  SET_VECTOR_ELT(contents, 359, ScalarReal(internal->drug_9_indic_ISev_GetICU_NoOx));
  SET_VECTOR_ELT(contents, 360, ScalarReal(internal->drug_9_NoOx_effect_size));
  SET_VECTOR_ELT(contents, 361, ScalarReal(internal->drug_9_prop_treat));
  SEXP E1_0 = PROTECT(allocVector(REALSXP, internal->dim_E1_0));
  memcpy(REAL(E1_0), internal->E1_0, internal->dim_E1_0 * sizeof(double));
  SET_VECTOR_ELT(contents, 362, E1_0);
  SEXP E2_0 = PROTECT(allocVector(REALSXP, internal->dim_E2_0));
  memcpy(REAL(E2_0), internal->E2_0, internal->dim_E2_0 * sizeof(double));
  SET_VECTOR_ELT(contents, 363, E2_0);
  SET_VECTOR_ELT(contents, 364, ScalarReal(internal->gamma_E));
  SET_VECTOR_ELT(contents, 365, ScalarReal(internal->gamma_IAsymp));
  SET_VECTOR_ELT(contents, 366, ScalarReal(internal->gamma_IAsymp_Drug_4));
  SET_VECTOR_ELT(contents, 367, ScalarReal(internal->gamma_ICase));
  SET_VECTOR_ELT(contents, 368, ScalarReal(internal->gamma_ICase_Drug_4));
  SET_VECTOR_ELT(contents, 369, ScalarReal(internal->gamma_ICrit_GetICU_GetOx_GetMV_Die));
  SET_VECTOR_ELT(contents, 370, ScalarReal(internal->gamma_ICrit_GetICU_GetOx_GetMV_Surv));
  SET_VECTOR_ELT(contents, 371, ScalarReal(internal->gamma_ICrit_GetICU_GetOx_GetMV_Surv_Drug_10));
  SET_VECTOR_ELT(contents, 372, ScalarReal(internal->gamma_ICrit_GetICU_GetOx_NoMV_Die));
  SET_VECTOR_ELT(contents, 373, ScalarReal(internal->gamma_ICrit_GetICU_GetOx_NoMV_Surv));
  SET_VECTOR_ELT(contents, 374, ScalarReal(internal->gamma_ICrit_GetICU_GetOx_NoMV_Surv_Drug_10));
  SET_VECTOR_ELT(contents, 375, ScalarReal(internal->gamma_ICrit_GetICU_NoOx_NoMV_Die));
  SET_VECTOR_ELT(contents, 376, ScalarReal(internal->gamma_ICrit_GetICU_NoOx_NoMV_Surv));
  SET_VECTOR_ELT(contents, 377, ScalarReal(internal->gamma_ICrit_GetICU_NoOx_NoMV_Surv_Drug_10));
  SET_VECTOR_ELT(contents, 378, ScalarReal(internal->gamma_ICrit_NoICU_NoOx_NoMV_Die));
  SET_VECTOR_ELT(contents, 379, ScalarReal(internal->gamma_ICrit_NoICU_NoOx_NoMV_Surv));
  SET_VECTOR_ELT(contents, 380, ScalarReal(internal->gamma_IMild));
  SET_VECTOR_ELT(contents, 381, ScalarReal(internal->gamma_IMild_Drug_4));
  SET_VECTOR_ELT(contents, 382, ScalarReal(internal->gamma_IMod_GetHosp_GetOx_Die));
  SET_VECTOR_ELT(contents, 383, ScalarReal(internal->gamma_IMod_GetHosp_GetOx_Surv));
  SET_VECTOR_ELT(contents, 384, ScalarReal(internal->gamma_IMod_GetHosp_GetOx_Surv_Drug_8));
  SET_VECTOR_ELT(contents, 385, ScalarReal(internal->gamma_IMod_GetHosp_NoOx_Die));
  SET_VECTOR_ELT(contents, 386, ScalarReal(internal->gamma_IMod_GetHosp_NoOx_Surv));
  SET_VECTOR_ELT(contents, 387, ScalarReal(internal->gamma_IMod_GetHosp_NoOx_Surv_Drug_8));
  SET_VECTOR_ELT(contents, 388, ScalarReal(internal->gamma_IMod_NoHosp_NoOx_Die));
  SET_VECTOR_ELT(contents, 389, ScalarReal(internal->gamma_IMod_NoHosp_NoOx_Surv));
  SET_VECTOR_ELT(contents, 390, ScalarReal(internal->gamma_IPreAsymp));
  SET_VECTOR_ELT(contents, 391, ScalarReal(internal->gamma_IPreAsymp_Drug_2));
  SET_VECTOR_ELT(contents, 392, ScalarReal(internal->gamma_IPreCase));
  SET_VECTOR_ELT(contents, 393, ScalarReal(internal->gamma_IPreCase_Drug_2));
  SET_VECTOR_ELT(contents, 394, ScalarReal(internal->gamma_IPreMild));
  SET_VECTOR_ELT(contents, 395, ScalarReal(internal->gamma_IPreMild_Drug_2));
  SET_VECTOR_ELT(contents, 396, ScalarReal(internal->gamma_ISev_GetICU_GetOx_Die));
  SET_VECTOR_ELT(contents, 397, ScalarReal(internal->gamma_ISev_GetICU_GetOx_Surv));
  SET_VECTOR_ELT(contents, 398, ScalarReal(internal->gamma_ISev_GetICU_GetOx_Surv_Drug_9));
  SET_VECTOR_ELT(contents, 399, ScalarReal(internal->gamma_ISev_GetICU_NoOx_Die));
  SET_VECTOR_ELT(contents, 400, ScalarReal(internal->gamma_ISev_GetICU_NoOx_Surv));
  SET_VECTOR_ELT(contents, 401, ScalarReal(internal->gamma_ISev_GetICU_NoOx_Surv_Drug_9));
  SET_VECTOR_ELT(contents, 402, ScalarReal(internal->gamma_ISev_NoICU_NoOx_Die));
  SET_VECTOR_ELT(contents, 403, ScalarReal(internal->gamma_ISev_NoICU_NoOx_Surv));
  SET_VECTOR_ELT(contents, 404, ScalarReal(internal->gamma_rec));
  ...
  SET_VECTOR_ELT(contents, 405, hosp_bed_capacity);
  ...
  SET_VECTOR_ELT(contents, 406, IAsymp_0);
  ...
  SET_VECTOR_ELT(contents, 407, ICase1_0);
  ...
  SET_VECTOR_ELT(contents, 408, ICase1Drug3_0);
  ...
  SET_VECTOR_ELT(contents, 409, ICase2_0);
  ...
  SET_VECTOR_ELT(contents, 410, ICase2Drug3_0);
  ...
  SET_VECTOR_ELT(contents, 411, ICrit_GetICU_GetOx_GetMV_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 412, ICrit_GetICU_GetOx_GetMV_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 413, ICrit_GetICU_GetOx_GetMV_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 414, ICrit_GetICU_GetOx_GetMV_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 415, ICrit_GetICU_GetOx_NoMV_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 416, ICrit_GetICU_GetOx_NoMV_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 417, ICrit_GetICU_GetOx_NoMV_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 418, ICrit_GetICU_GetOx_NoMV_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 419, ICrit_GetICU_NoOx_NoMV_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 420, ICrit_GetICU_NoOx_NoMV_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 421, ICrit_GetICU_NoOx_NoMV_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 422, ICrit_GetICU_NoOx_NoMV_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 423, ICrit_NoICU_NoOx_NoMV_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 424, ICrit_NoICU_NoOx_NoMV_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 425, ICrit_NoICU_NoOx_NoMV_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 426, ICrit_NoICU_NoOx_NoMV_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 427, ICU_bed_capacity);
  ...
  SET_VECTOR_ELT(contents, 428, IMild_0);
  ...
  SET_VECTOR_ELT(contents, 429, IMod_GetHosp_GetOx_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 430, IMod_GetHosp_GetOx_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 431, IMod_GetHosp_GetOx_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 432, IMod_GetHosp_GetOx_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 433, IMod_GetHosp_NoOx_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 434, IMod_GetHosp_NoOx_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 435, IMod_GetHosp_NoOx_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 436, IMod_GetHosp_NoOx_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 437, IMod_NoHosp_NoOx_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 438, IMod_NoHosp_NoOx_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 439, IMod_NoHosp_NoOx_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 440, IMod_NoHosp_NoOx_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 441, initial_D);
  ...
  SET_VECTOR_ELT(contents, 442, initial_D_Community);
  ...
  SET_VECTOR_ELT(contents, 443, initial_D_Hospital);
  ...
  SET_VECTOR_ELT(contents, 444, initial_E1);
  ...
  SET_VECTOR_ELT(contents, 445, initial_E2);
  ...
  SET_VECTOR_ELT(contents, 446, initial_IAsymp);
  ...
  SET_VECTOR_ELT(contents, 447, initial_ICase1);
  ...
  SET_VECTOR_ELT(contents, 448, initial_ICase1Drug3);
  ...
  SET_VECTOR_ELT(contents, 449, initial_ICase2);
  ...
  SET_VECTOR_ELT(contents, 450, initial_ICase2Drug3);
  ...
  SET_VECTOR_ELT(contents, 451, initial_ICrit_GetICU_GetOx_GetMV_Die1);
  ...
  SET_VECTOR_ELT(contents, 452, initial_ICrit_GetICU_GetOx_GetMV_Die2);
  ...
  SET_VECTOR_ELT(contents, 453, initial_ICrit_GetICU_GetOx_GetMV_Surv1);
  ...
  SET_VECTOR_ELT(contents, 454, initial_ICrit_GetICU_GetOx_GetMV_Surv2);
  ...
  SET_VECTOR_ELT(contents, 455, initial_ICrit_GetICU_GetOx_NoMV_Die1);
  ...
  SET_VECTOR_ELT(contents, 456, initial_ICrit_GetICU_GetOx_NoMV_Die2);
  ...
  SET_VECTOR_ELT(contents, 457, initial_ICrit_GetICU_GetOx_NoMV_Surv1);
  ...
  SET_VECTOR_ELT(contents, 458, initial_ICrit_GetICU_GetOx_NoMV_Surv2);
  ...
  SET_VECTOR_ELT(contents, 459, initial_ICrit_GetICU_NoOx_NoMV_Die1);
  ...
  SET_VECTOR_ELT(contents, 460, initial_ICrit_GetICU_NoOx_NoMV_Die2);
  ...
  SET_VECTOR_ELT(contents, 461, initial_ICrit_GetICU_NoOx_NoMV_Surv1);
  ...
  SET_VECTOR_ELT(contents, 462, initial_ICrit_GetICU_NoOx_NoMV_Surv2);
  ...
  SET_VECTOR_ELT(contents, 463, initial_ICrit_NoICU_NoOx_NoMV_Die1);
  ...
  SET_VECTOR_ELT(contents, 464, initial_ICrit_NoICU_NoOx_NoMV_Die2);
  ...
  SET_VECTOR_ELT(contents, 465, initial_ICrit_NoICU_NoOx_NoMV_Surv1);
  ...
  SET_VECTOR_ELT(contents, 466, initial_ICrit_NoICU_NoOx_NoMV_Surv2);
  ...
  SET_VECTOR_ELT(contents, 467, initial_IMild);
  ...
  SET_VECTOR_ELT(contents, 468, initial_IMod_GetHosp_GetOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 469, initial_IMod_GetHosp_GetOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 470, initial_IMod_GetHosp_GetOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 471, initial_IMod_GetHosp_GetOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 472, initial_IMod_GetHosp_NoOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 473, initial_IMod_GetHosp_NoOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 474, initial_IMod_GetHosp_NoOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 475, initial_IMod_GetHosp_NoOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 476, initial_IMod_NoHosp_NoOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 477, initial_IMod_NoHosp_NoOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 478, initial_IMod_NoHosp_NoOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 479, initial_IMod_NoHosp_NoOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 480, initial_IPre1Asymp);
  ...
  SET_VECTOR_ELT(contents, 481, initial_IPre1Case);
  ...
  SET_VECTOR_ELT(contents, 482, initial_IPre1CaseDrug3);
  ...
  SET_VECTOR_ELT(contents, 483, initial_IPre1Mild);
  ...
  SET_VECTOR_ELT(contents, 484, initial_IPre2Asymp);
  ...
  SET_VECTOR_ELT(contents, 485, initial_IPre2Case);
  ...
  SET_VECTOR_ELT(contents, 486, initial_IPre2CaseDrug3);
  ...
  SET_VECTOR_ELT(contents, 487, initial_IPre2Mild);
  ...
  SET_VECTOR_ELT(contents, 488, initial_IRec1);
  ...
  SET_VECTOR_ELT(contents, 489, initial_IRec2);
  ...
  SET_VECTOR_ELT(contents, 490, initial_ISev_GetICU_GetOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 491, initial_ISev_GetICU_GetOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 492, initial_ISev_GetICU_GetOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 493, initial_ISev_GetICU_GetOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 494, initial_ISev_GetICU_NoOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 495, initial_ISev_GetICU_NoOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 496, initial_ISev_GetICU_NoOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 497, initial_ISev_GetICU_NoOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 498, initial_ISev_NoICU_NoOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 499, initial_ISev_NoICU_NoOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 500, initial_ISev_NoICU_NoOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 501, initial_ISev_NoICU_NoOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 502, initial_PE1);
  ...
  SET_VECTOR_ELT(contents, 503, initial_PE2);
  ...
  SET_VECTOR_ELT(contents, 504, initial_PS);
  ...
  SET_VECTOR_ELT(contents, 505, initial_R);
  ...
  SET_VECTOR_ELT(contents, 506, initial_S);
  ...
  SET_VECTOR_ELT(contents, 513, IPre1Asymp_0);
  ...
  SET_VECTOR_ELT(contents, 514, IPre1Case_0);
  ...
  SET_VECTOR_ELT(contents, 515, IPre1CaseDrug3_0);
  ...
  SET_VECTOR_ELT(contents, 516, IPre1Mild_0);
  ...
  SET_VECTOR_ELT(contents, 517, IPre2Asymp_0);
  ...
  SET_VECTOR_ELT(contents, 518, IPre2Case_0);
  ...
  SET_VECTOR_ELT(contents, 519, IPre2CaseDrug3_0);
  ...
  SET_VECTOR_ELT(contents, 520, IPre2Mild_0);
  ...
  SET_VECTOR_ELT(contents, 521, IRec1_0);
  ...
  SET_VECTOR_ELT(contents, 522, IRec2_0);
  ...
  SET_VECTOR_ELT(contents, 523, ISev_GetICU_GetOx_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 524, ISev_GetICU_GetOx_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 525, ISev_GetICU_GetOx_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 526, ISev_GetICU_GetOx_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 527, ISev_GetICU_NoOx_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 528, ISev_GetICU_NoOx_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 529, ISev_GetICU_NoOx_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 530, ISev_GetICU_NoOx_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 531, ISev_NoICU_NoOx_Die1_0);
  ...
  SET_VECTOR_ELT(contents, 532, ISev_NoICU_NoOx_Die2_0);
  ...
  SET_VECTOR_ELT(contents, 533, ISev_NoICU_NoOx_Surv1_0);
  ...
  SET_VECTOR_ELT(contents, 534, ISev_NoICU_NoOx_Surv2_0);
  ...
  SET_VECTOR_ELT(contents, 535, lambda);
  ...
  SET_VECTOR_ELT(contents, 537, mix_mat_set);
  SET_VECTOR_ELT(contents, 538, ScalarReal(internal->MV_capacity));
  SET_VECTOR_ELT(contents, 539, ScalarInteger(internal->N_age));
  ...
  SET_VECTOR_ELT(contents, 540, n_E1_E2);
  ...
  SET_VECTOR_ELT(contents, 541, n_E2_IPre);
  ...
  SET_VECTOR_ELT(contents, 542, n_E2_IPre1Asymp);
  ...
  SET_VECTOR_ELT(contents, 543, n_E2_IPre1ICase);
  ...
  SET_VECTOR_ELT(contents, 544, n_E2_IPre1ICase_initial);
  ...
  SET_VECTOR_ELT(contents, 545, n_E2_IPre1ICaseDrug3);
  ...
  SET_VECTOR_ELT(contents, 546, n_E2_IPre1Mild);
  ...
  SET_VECTOR_ELT(contents, 547, n_E2_IPre1Mild_or_IPre1Asymp);
  ...
  SET_VECTOR_ELT(contents, 548, n_IAsymp_R);
  ...
  SET_VECTOR_ELT(contents, 549, n_ICase1_ICase2);
  ...
  SET_VECTOR_ELT(contents, 550, n_ICase1Drug3_ICase2Drug3);
  ...
  SET_VECTOR_ELT(contents, 551, n_ICase2_Hosp);
  ...
  SET_VECTOR_ELT(contents, 552, n_ICase2Drug3_R);
  ...
  SET_VECTOR_ELT(contents, 553, n_ICrit_GetICU_GetOx_GetMV_Die1);
  ...
  SET_VECTOR_ELT(contents, 554, n_ICrit_GetICU_GetOx_GetMV_Die1_ICrit_GetICU_GetOx_GetMV_Die2);
  ...
  SET_VECTOR_ELT(contents, 555, n_ICrit_GetICU_GetOx_GetMV_Die2_D_Hospital);
  ...
  SET_VECTOR_ELT(contents, 556, n_ICrit_GetICU_GetOx_GetMV_Surv1);
  ...
  SET_VECTOR_ELT(contents, 557, n_ICrit_GetICU_GetOx_GetMV_Surv1_ICrit_GetICU_GetOx_GetMV_Surv2);
  ...
  SET_VECTOR_ELT(contents, 558, n_ICrit_GetICU_GetOx_GetMV_Surv2_Rec);
  ...
  SET_VECTOR_ELT(contents, 559, n_ICrit_GetICU_GetOx_NoMV_Die1);
  ...
  SET_VECTOR_ELT(contents, 560, n_ICrit_GetICU_GetOx_NoMV_Die1_ICrit_GetICU_GetOx_NoMV_Die2);
  ...
  SET_VECTOR_ELT(contents, 561, n_ICrit_GetICU_GetOx_NoMV_Die2_D_Hospital);
  ...
  SET_VECTOR_ELT(contents, 562, n_ICrit_GetICU_GetOx_NoMV_Surv1);
  ...
  SET_VECTOR_ELT(contents, 563, n_ICrit_GetICU_GetOx_NoMV_Surv1_ICrit_GetICU_GetOx_NoMV_Surv2);
  ...
  SET_VECTOR_ELT(contents, 564, n_ICrit_GetICU_GetOx_NoMV_Surv2_Rec);
  ...
  SET_VECTOR_ELT(contents, 565, n_ICrit_GetICU_NoOx_NoMV_Die1);
  ...
  SET_VECTOR_ELT(contents, 566, n_ICrit_GetICU_NoOx_NoMV_Die1_ICrit_GetICU_NoOx_NoMV_Die2);
  ...
  SET_VECTOR_ELT(contents, 567, n_ICrit_GetICU_NoOx_NoMV_Die2_D_Hospital);
  ...
  SET_VECTOR_ELT(contents, 568, n_ICrit_GetICU_NoOx_NoMV_Surv1);
  ...
  SET_VECTOR_ELT(contents, 569, n_ICrit_GetICU_NoOx_NoMV_Surv1_ICrit_GetICU_NoOx_NoMV_Surv2);
  ...
  SET_VECTOR_ELT(contents, 570, n_ICrit_GetICU_NoOx_NoMV_Surv2_Rec);
  ...
  SET_VECTOR_ELT(contents, 571, n_ICrit_NoICU_NoOx_NoMV_Die1);
  ...
  SET_VECTOR_ELT(contents, 572, n_ICrit_NoICU_NoOx_NoMV_Die1_ICrit_NoICU_NoOx_NoMV_Die2);
  ...
  SET_VECTOR_ELT(contents, 573, n_ICrit_NoICU_NoOx_NoMV_Die2_D_Community);
  ...
  SET_VECTOR_ELT(contents, 574, n_ICrit_NoICU_NoOx_NoMV_Surv1);
  ...
  SET_VECTOR_ELT(contents, 575, n_ICrit_NoICU_NoOx_NoMV_Surv1_ICrit_NoICU_NoOx_NoMV_Surv2);
  ...
  SET_VECTOR_ELT(contents, 576, n_ICrit_NoICU_NoOx_NoMV_Surv2_R);
  ...
  SET_VECTOR_ELT(contents, 577, n_IMild_R);
  ...
  SET_VECTOR_ELT(contents, 578, n_IMod_GetHosp_GetOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 579, n_IMod_GetHosp_GetOx_Die1_IMod_GetHosp_GetOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 580, n_IMod_GetHosp_GetOx_Die2_D_Hospital);
  ...
  SET_VECTOR_ELT(contents, 581, n_IMod_GetHosp_GetOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 582, n_IMod_GetHosp_GetOx_Surv1_IMod_GetHosp_GetOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 583, n_IMod_GetHosp_GetOx_Surv2_R);
  ...
  SET_VECTOR_ELT(contents, 584, n_IMod_GetHosp_NoOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 585, n_IMod_GetHosp_NoOx_Die1_IMod_GetHosp_NoOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 586, n_IMod_GetHosp_NoOx_Die2_D_Hospital);
  ...
  SET_VECTOR_ELT(contents, 587, n_IMod_GetHosp_NoOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 588, n_IMod_GetHosp_NoOx_Surv1_IMod_GetHosp_NoOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 589, n_IMod_GetHosp_NoOx_Surv2_R);
  ...
  SET_VECTOR_ELT(contents, 590, n_IMod_NoHosp_NoOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 591, n_IMod_NoHosp_NoOx_Die1_IMod_NoHosp_NoOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 592, n_IMod_NoHosp_NoOx_Die2_D_Community);
  ...
  SET_VECTOR_ELT(contents, 593, n_IMod_NoHosp_NoOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 594, n_IMod_NoHosp_NoOx_Surv1_IMod_NoHosp_NoOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 595, n_IMod_NoHosp_NoOx_Surv2_R);
  ...
  SET_VECTOR_ELT(contents, 596, n_IPre1_Asymp_IPre2_Asymp);
  ...
  SET_VECTOR_ELT(contents, 597, n_IPre1_Case_IPre2_Case);
  ...
  SET_VECTOR_ELT(contents, 598, n_IPre1_CaseDrug3_IPre2_CaseDrug3);
  ...
  SET_VECTOR_ELT(contents, 599, n_IPre1_Mild_IPre2_Mild);
  ...
  SET_VECTOR_ELT(contents, 600, n_IPre2_Asymp_IAsymp);
  ...
  SET_VECTOR_ELT(contents, 601, n_IPre2_Case_ICase1);
  ...
  SET_VECTOR_ELT(contents, 602, n_IPre2_CaseDrug3_ICase1Drug3);
  ...
  SET_VECTOR_ELT(contents, 603, n_IPre2_Mild_IMild);
  ...
  SET_VECTOR_ELT(contents, 604, n_IRec1_IRec2);
  ...
  SET_VECTOR_ELT(contents, 605, n_IRec2_R);
  ...
  SET_VECTOR_ELT(contents, 606, n_ISev_GetICU_GetOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 607, n_ISev_GetICU_GetOx_Die1_ISev_GetICU_GetOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 608, n_ISev_GetICU_GetOx_Die2_D_Hospital);
  ...
  SET_VECTOR_ELT(contents, 609, n_ISev_GetICU_GetOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 610, n_ISev_GetICU_GetOx_Surv1_ISev_GetICU_GetOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 611, n_ISev_GetICU_GetOx_Surv2_Rec);
  ...
  SET_VECTOR_ELT(contents, 612, n_ISev_GetICU_NoOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 613, n_ISev_GetICU_NoOx_Die1_ISev_GetICU_NoOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 614, n_ISev_GetICU_NoOx_Die2_D_Hospital);
  ...
  SET_VECTOR_ELT(contents, 615, n_ISev_GetICU_NoOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 616, n_ISev_GetICU_NoOx_Surv1_ISev_GetICU_NoOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 617, n_ISev_GetICU_NoOx_Surv2_Rec);
  ...
  SET_VECTOR_ELT(contents, 618, n_ISev_NoICU_NoOx_Die1);
  ...
  SET_VECTOR_ELT(contents, 619, n_ISev_NoICU_NoOx_Die1_ISev_NoICU_NoOx_Die2);
  ...
  SET_VECTOR_ELT(contents, 620, n_ISev_NoICU_NoOx_Die2_D_Community);
  ...
  SET_VECTOR_ELT(contents, 621, n_ISev_NoICU_NoOx_Surv1);
  ...
  SET_VECTOR_ELT(contents, 622, n_ISev_NoICU_NoOx_Surv1_ISev_NoICU_NoOx_Surv2);
  ...
  SET_VECTOR_ELT(contents, 623, n_ISev_NoICU_NoOx_Surv2_R);
  ...
  SET_VECTOR_ELT(contents, 624, n_PE1_PE2);
  ...
  SET_VECTOR_ELT(contents, 625, n_PE2_IPre);
  ...
  SET_VECTOR_ELT(contents, 626, n_PS_PE1);
  ...
  SET_VECTOR_ELT(contents, 627, n_PS_S);
  ...
  SET_VECTOR_ELT(contents, 628, n_S_E1);
  ...
  SET_VECTOR_ELT(contents, 629, n_S_PS);
  ...
  SET_VECTOR_ELT(contents, 630, number_GetICU_GetOx);
  ...
  SET_VECTOR_ELT(contents, 631, number_GetICU_GetOx_to_IMod);
  ...
  SET_VECTOR_ELT(contents, 632, number_GetICU_NoOx);
  ...
  SET_VECTOR_ELT(contents, 633, number_GetICU_NoOx_to_IMod);
  ...
  SET_VECTOR_ELT(contents, 634, number_ICrit_GetICU_GetOx);
  ...
  SET_VECTOR_ELT(contents, 635, number_ICrit_GetICU_GetOx_GetMV);
  ...
  SET_VECTOR_ELT(contents, 636, number_ICrit_GetICU_GetOx_initial);
  ...
  SET_VECTOR_ELT(contents, 637, number_ICrit_GetICU_GetOx_NoMV);
  ...
  SET_VECTOR_ELT(contents, 638, number_ICrit_GetICU_NoOx_NoMV);
  ...
  SET_VECTOR_ELT(contents, 639, number_ICrit_GetICU_NoOx_NoMV_initial);
  ...
  SET_VECTOR_ELT(contents, 640, number_ICrit_NoICU_NoOx_NoMV);
  ...
  SET_VECTOR_ELT(contents, 641, number_IMod_GetHosp_GetOx);
  ...
  SET_VECTOR_ELT(contents, 642, number_IMod_GetHosp_NoOx);
  ...
  SET_VECTOR_ELT(contents, 643, number_IMod_NoHosp_NoOx);
  ...
  SET_VECTOR_ELT(contents, 644, number_ISev_GetICU_GetOx);
  ...
  SET_VECTOR_ELT(contents, 645, number_ISev_GetICU_NoOx);
  ...
  SET_VECTOR_ELT(contents, 646, number_ISev_NoICU_NoOx);
  ...
  SET_VECTOR_ELT(contents, 647, number_NoICU);
  ...
  SET_VECTOR_ELT(contents, 648, number_req_Hosp);
  ...
  SET_VECTOR_ELT(contents, 649, number_req_hosp_remaining);
  ...
  SET_VECTOR_ELT(contents, 650, number_req_ICU);
  ...
  SET_VECTOR_ELT(contents, 651, number_req_ICU_remaining);
  SET_VECTOR_ELT(contents, 652, ScalarInteger(internal->offset_output_n_E2_IPre));
  SET_VECTOR_ELT(contents, 653, ScalarInteger(internal->offset_output_n_E2_IPre1ICase));
  SET_VECTOR_ELT(contents, 654, ScalarInteger(internal->offset_output_n_ICase2_Hosp));
  SET_VECTOR_ELT(contents, 655, ScalarInteger(internal->offset_output_n_ICrit_GetICU_GetOx_GetMV_Surv1));
  SET_VECTOR_ELT(contents, 656, ScalarInteger(internal->offset_output_n_ICrit_GetICU_GetOx_GetMV_Surv1_ICrit_GetICU_GetOx_GetMV_Surv2));
  SET_VECTOR_ELT(contents, 657, ScalarInteger(internal->offset_output_n_ICrit_GetICU_GetOx_GetMV_Surv2_Rec));
  SET_VECTOR_ELT(contents, 658, ScalarInteger(internal->offset_output_n_ICrit_GetICU_GetOx_NoMV_Surv2_Rec));
  SET_VECTOR_ELT(contents, 659, ScalarInteger(internal->offset_output_n_ICrit_GetICU_NoOx_NoMV_Die2_D_Hospital));
  SET_VECTOR_ELT(contents, 660, ScalarInteger(internal->offset_output_n_ICrit_GetICU_NoOx_NoMV_Surv2_Rec));
  SET_VECTOR_ELT(contents, 661, ScalarInteger(internal->offset_output_n_IMod_GetHosp_GetOx_Die1));
  SET_VECTOR_ELT(contents, 662, ScalarInteger(internal->offset_output_n_IMod_GetHosp_GetOx_Die2_D_Hospital));
  SET_VECTOR_ELT(contents, 663, ScalarInteger(internal->offset_output_n_IMod_GetHosp_GetOx_Surv2_R));
  SET_VECTOR_ELT(contents, 664, ScalarInteger(internal->offset_output_n_IMod_GetHosp_NoOx_Die1));
  SET_VECTOR_ELT(contents, 665, ScalarInteger(internal->offset_output_n_IMod_GetHosp_NoOx_Surv2_R));
  SET_VECTOR_ELT(contents, 666, ScalarInteger(internal->offset_output_n_IMod_NoHosp_NoOx_Die1));
  SET_VECTOR_ELT(contents, 667, ScalarInteger(internal->offset_output_n_ISev_GetICU_GetOx_Die1));
  SET_VECTOR_ELT(contents, 668, ScalarInteger(internal->offset_output_n_ISev_GetICU_GetOx_Surv1));
  SET_VECTOR_ELT(contents, 669, ScalarInteger(internal->offset_output_n_ISev_GetICU_GetOx_Surv1_ISev_GetICU_GetOx_Surv2));
  SET_VECTOR_ELT(contents, 670, ScalarInteger(internal->offset_output_n_ISev_GetICU_GetOx_Surv2_Rec));
  SET_VECTOR_ELT(contents, 671, ScalarInteger(internal->offset_output_n_ISev_GetICU_NoOx_Die2_D_Hospital));
  SET_VECTOR_ELT(contents, 672, ScalarInteger(internal->offset_output_n_ISev_GetICU_NoOx_Surv2_Rec));
  SET_VECTOR_ELT(contents, 673, ScalarInteger(internal->offset_output_n_PE1_PE2));
  SET_VECTOR_ELT(contents, 674, ScalarInteger(internal->offset_output_n_PS_PE1));
  SET_VECTOR_ELT(contents, 675, ScalarInteger(internal->offset_output_n_PS_S));
  SET_VECTOR_ELT(contents, 676, ScalarInteger(internal->offset_output_n_S_PS));
  SET_VECTOR_ELT(contents, 677, ScalarInteger(internal->offset_output_number_GetICU_GetOx));
  SET_VECTOR_ELT(contents, 678, ScalarInteger(internal->offset_output_number_GetICU_GetOx_to_IMod));
  SET_VECTOR_ELT(contents, 679, ScalarInteger(internal->offset_output_number_GetICU_NoOx));
  SET_VECTOR_ELT(contents, 680, ScalarInteger(internal->offset_output_number_GetICU_NoOx_to_IMod));
  SET_VECTOR_ELT(contents, 681, ScalarInteger(internal->offset_output_number_ICrit_GetICU_GetOx));
  SET_VECTOR_ELT(contents, 682, ScalarInteger(internal->offset_output_number_ICrit_GetICU_GetOx_GetMV));
  SET_VECTOR_ELT(contents, 683, ScalarInteger(internal->offset_output_number_ICrit_GetICU_GetOx_NoMV));
  SET_VECTOR_ELT(contents, 684, ScalarInteger(internal->offset_output_number_ICrit_GetICU_NoOx_NoMV));
  SET_VECTOR_ELT(contents, 685, ScalarInteger(internal->offset_output_number_ICrit_NoICU_NoOx_NoMV));
  SET_VECTOR_ELT(contents, 686, ScalarInteger(internal->offset_output_number_IMod_GetHosp_GetOx));
  SET_VECTOR_ELT(contents, 687, ScalarInteger(internal->offset_output_number_IMod_GetHosp_NoOx));
  SET_VECTOR_ELT(contents, 688, ScalarInteger(internal->offset_output_number_IMod_NoHosp_NoOx));
  SET_VECTOR_ELT(contents, 689, ScalarInteger(internal->offset_output_number_ISev_GetICU_GetOx));
  SET_VECTOR_ELT(contents, 690, ScalarInteger(internal->offset_output_number_ISev_GetICU_NoOx));
  SET_VECTOR_ELT(contents, 691, ScalarInteger(internal->offset_output_number_ISev_NoICU_NoOx));
  SET_VECTOR_ELT(contents, 692, ScalarInteger(internal->offset_output_number_NoICU));
  SET_VECTOR_ELT(contents, 693, ScalarInteger(internal->offset_output_number_req_Hosp));
  SET_VECTOR_ELT(contents, 694, ScalarInteger(internal->offset_output_number_req_ICU));
  SET_VECTOR_ELT(contents, 695, ScalarInteger(internal->offset_output_number_req_ICU_remaining));
  SET_VECTOR_ELT(contents, 696, ScalarInteger(internal->offset_output_prob_critical_death_get_ICU_get_ox_get_MV));
  SET_VECTOR_ELT(contents, 697, ScalarInteger(internal->offset_output_prob_critical_death_get_ICU_get_ox_get_MV_baseline));
  SET_VECTOR_ELT(contents, 698, ScalarInteger(internal->offset_output_prob_critical_death_get_ICU_get_ox_get_MV_Drug_13));
  SET_VECTOR_ELT(contents, 699, ScalarInteger(internal->offset_output_prob_critical_death_get_ICU_get_ox_no_MV));
  SET_VECTOR_ELT(contents, 700, ScalarInteger(internal->offset_output_prob_critical_death_get_ICU_get_ox_no_MV_baseline));
  SET_VECTOR_ELT(contents, 701, ScalarInteger(internal->offset_output_prob_critical_death_get_ICU_get_ox_no_MV_Drug_13));
  SET_VECTOR_ELT(contents, 702, ScalarInteger(internal->offset_output_prob_critical_death_get_ICU_no_ox_no_MV));
  SET_VECTOR_ELT(contents, 703, ScalarInteger(internal->offset_output_prob_critical_death_get_ICU_no_ox_no_MV_baseline));
  SET_VECTOR_ELT(contents, 704, ScalarInteger(internal->offset_output_prob_critical_death_get_ICU_no_ox_no_MV_Drug_13));
  SET_VECTOR_ELT(contents, 705, ScalarInteger(internal->offset_output_prob_moderate_death_get_hosp_get_ox));
  SET_VECTOR_ELT(contents, 706, ScalarInteger(internal->offset_output_prob_moderate_death_get_hosp_get_ox_baseline));
  SET_VECTOR_ELT(contents, 707, ScalarInteger(internal->offset_output_prob_moderate_death_get_hosp_get_ox_Drug_11));
  SET_VECTOR_ELT(contents, 708, ScalarInteger(internal->offset_output_prob_moderate_death_get_hosp_no_ox));
  SET_VECTOR_ELT(contents, 709, ScalarInteger(internal->offset_output_prob_moderate_death_get_hosp_no_ox_baseline));
  SET_VECTOR_ELT(contents, 710, ScalarInteger(internal->offset_output_prob_moderate_death_get_hosp_no_ox_Drug_11));
  SET_VECTOR_ELT(contents, 711, ScalarInteger(internal->offset_output_prob_severe_death_get_ICU_get_ox));
  SET_VECTOR_ELT(contents, 712, ScalarInteger(internal->offset_output_prob_severe_death_get_ICU_get_ox_baseline));
  SET_VECTOR_ELT(contents, 713, ScalarInteger(internal->offset_output_prob_severe_death_get_ICU_get_ox_Drug_12));
  SET_VECTOR_ELT(contents, 714, ScalarInteger(internal->offset_output_prob_severe_death_get_ICU_no_ox));
  SET_VECTOR_ELT(contents, 715, ScalarInteger(internal->offset_output_prob_severe_death_get_ICU_no_ox_baseline));
  SET_VECTOR_ELT(contents, 716, ScalarInteger(internal->offset_output_prob_severe_death_get_ICU_no_ox_Drug_12));
  SET_VECTOR_ELT(contents, 717, ScalarInteger(internal->offset_output_test_number_req_Hosp));
  SET_VECTOR_ELT(contents, 718, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 719, ScalarInteger(internal->offset_variable_D_Community));
  SET_VECTOR_ELT(contents, 720, ScalarInteger(internal->offset_variable_D_Hospital));
  SET_VECTOR_ELT(contents, 721, ScalarInteger(internal->offset_variable_E2));
  SET_VECTOR_ELT(contents, 722, ScalarInteger(internal->offset_variable_IAsymp));
  SET_VECTOR_ELT(contents, 723, ScalarInteger(internal->offset_variable_ICase1));
  SET_VECTOR_ELT(contents, 724, ScalarInteger(internal->offset_variable_ICase1Drug3));
  SET_VECTOR_ELT(contents, 725, ScalarInteger(internal->offset_variable_ICase2));
  SET_VECTOR_ELT(contents, 726, ScalarInteger(internal->offset_variable_ICase2Drug3));
  SET_VECTOR_ELT(contents, 727, ScalarInteger(internal->offset_variable_ICrit_GetICU_GetOx_GetMV_Die1));
  SET_VECTOR_ELT(contents, 728, ScalarInteger(internal->offset_variable_ICrit_GetICU_GetOx_GetMV_Die2));
  SET_VECTOR_ELT(contents, 729, ScalarInteger(internal->offset_variable_ICrit_GetICU_GetOx_GetMV_Surv1));
  SET_VECTOR_ELT(contents, 730, ScalarInteger(internal->offset_variable_ICrit_GetICU_GetOx_GetMV_Surv2));
  SET_VECTOR_ELT(contents, 731, ScalarInteger(internal->offset_variable_ICrit_GetICU_GetOx_NoMV_Die1));
  SET_VECTOR_ELT(contents, 732, ScalarInteger(internal->offset_variable_ICrit_GetICU_GetOx_NoMV_Die2));
  SET_VECTOR_ELT(contents, 733, ScalarInteger(internal->offset_variable_ICrit_GetICU_GetOx_NoMV_Surv1));
  SET_VECTOR_ELT(contents, 734, ScalarInteger(internal->offset_variable_ICrit_GetICU_GetOx_NoMV_Surv2));
  SET_VECTOR_ELT(contents, 735, ScalarInteger(internal->offset_variable_ICrit_GetICU_NoOx_NoMV_Die1));
  SET_VECTOR_ELT(contents, 736, ScalarInteger(internal->offset_variable_ICrit_GetICU_NoOx_NoMV_Die2));
  SET_VECTOR_ELT(contents, 737, ScalarInteger(internal->offset_variable_ICrit_GetICU_NoOx_NoMV_Surv1));
  SET_VECTOR_ELT(contents, 738, ScalarInteger(internal->offset_variable_ICrit_GetICU_NoOx_NoMV_Surv2));
  SET_VECTOR_ELT(contents, 739, ScalarInteger(internal->offset_variable_ICrit_NoICU_NoOx_NoMV_Die1));
  SET_VECTOR_ELT(contents, 740, ScalarInteger(internal->offset_variable_ICrit_NoICU_NoOx_NoMV_Die2));
  SET_VECTOR_ELT(contents, 741, ScalarInteger(internal->offset_variable_ICrit_NoICU_NoOx_NoMV_Surv1));
  SET_VECTOR_ELT(contents, 742, ScalarInteger(internal->offset_variable_ICrit_NoICU_NoOx_NoMV_Surv2));
  SET_VECTOR_ELT(contents, 743, ScalarInteger(internal->offset_variable_IMild));
  SET_VECTOR_ELT(contents, 744, ScalarInteger(internal->offset_variable_IMod_GetHosp_GetOx_Die1));
  SET_VECTOR_ELT(contents, 745, ScalarInteger(internal->offset_variable_IMod_GetHosp_GetOx_Die2));
  SET_VECTOR_ELT(contents, 746, ScalarInteger(internal->offset_variable_IMod_GetHosp_GetOx_Surv1));
  SET_VECTOR_ELT(contents, 747, ScalarInteger(internal->offset_variable_IMod_GetHosp_GetOx_Surv2));
  SET_VECTOR_ELT(contents, 748, ScalarInteger(internal->offset_variable_IMod_GetHosp_NoOx_Die1));
  SET_VECTOR_ELT(contents, 749, ScalarInteger(internal->offset_variable_IMod_GetHosp_NoOx_Die2));
  SET_VECTOR_ELT(contents, 750, ScalarInteger(internal->offset_variable_IMod_GetHosp_NoOx_Surv1));
  SET_VECTOR_ELT(contents, 751, ScalarInteger(internal->offset_variable_IMod_GetHosp_NoOx_Surv2));
  SET_VECTOR_ELT(contents, 752, ScalarInteger(internal->offset_variable_IMod_NoHosp_NoOx_Die1));
  SET_VECTOR_ELT(contents, 753, ScalarInteger(internal->offset_variable_IMod_NoHosp_NoOx_Die2));
  SET_VECTOR_ELT(contents, 754, ScalarInteger(internal->offset_variable_IMod_NoHosp_NoOx_Surv1));
  SET_VECTOR_ELT(contents, 755, ScalarInteger(internal->offset_variable_IMod_NoHosp_NoOx_Surv2));
  SET_VECTOR_ELT(contents, 756, ScalarInteger(internal->offset_variable_IPre1Asymp));
  SET_VECTOR_ELT(contents, 757, ScalarInteger(internal->offset_variable_IPre1Case));
  SET_VECTOR_ELT(contents, 758, ScalarInteger(internal->offset_variable_IPre1CaseDrug3));
  SET_VECTOR_ELT(contents, 759, ScalarInteger(internal->offset_variable_IPre1Mild));
  SET_VECTOR_ELT(contents, 760, ScalarInteger(internal->offset_variable_IPre2Asymp));
  SET_VECTOR_ELT(contents, 761, ScalarInteger(internal->offset_variable_IPre2Case));
  SET_VECTOR_ELT(contents, 762, ScalarInteger(internal->offset_variable_IPre2CaseDrug3));
  SET_VECTOR_ELT(contents, 763, ScalarInteger(internal->offset_variable_IPre2Mild));
  SET_VECTOR_ELT(contents, 764, ScalarInteger(internal->offset_variable_IRec1));
  SET_VECTOR_ELT(contents, 765, ScalarInteger(internal->offset_variable_IRec2));
  SET_VECTOR_ELT(contents, 766, ScalarInteger(internal->offset_variable_ISev_GetICU_GetOx_Die1));
  SET_VECTOR_ELT(contents, 767, ScalarInteger(internal->offset_variable_ISev_GetICU_GetOx_Die2));
  SET_VECTOR_ELT(contents, 768, ScalarInteger(internal->offset_variable_ISev_GetICU_GetOx_Surv1));
  SET_VECTOR_ELT(contents, 769, ScalarInteger(internal->offset_variable_ISev_GetICU_GetOx_Surv2));
  SET_VECTOR_ELT(contents, 770, ScalarInteger(internal->offset_variable_ISev_GetICU_NoOx_Die1));
  SET_VECTOR_ELT(contents, 771, ScalarInteger(internal->offset_variable_ISev_GetICU_NoOx_Die2));
  SET_VECTOR_ELT(contents, 772, ScalarInteger(internal->offset_variable_ISev_GetICU_NoOx_Surv1));
  SET_VECTOR_ELT(contents, 773, ScalarInteger(internal->offset_variable_ISev_GetICU_NoOx_Surv2));
  SET_VECTOR_ELT(contents, 774, ScalarInteger(internal->offset_variable_ISev_NoICU_NoOx_Die1));
  SET_VECTOR_ELT(contents, 775, ScalarInteger(internal->offset_variable_ISev_NoICU_NoOx_Die2));
  SET_VECTOR_ELT(contents, 776, ScalarInteger(internal->offset_variable_ISev_NoICU_NoOx_Surv1));
  SET_VECTOR_ELT(contents, 777, ScalarInteger(internal->offset_variable_ISev_NoICU_NoOx_Surv2));
  SET_VECTOR_ELT(contents, 778, ScalarInteger(internal->offset_variable_PE1));
  SET_VECTOR_ELT(contents, 779, ScalarInteger(internal->offset_variable_PE2));
  SET_VECTOR_ELT(contents, 780, ScalarInteger(internal->offset_variable_PS));
  SET_VECTOR_ELT(contents, 781, ScalarInteger(internal->offset_variable_R));
  ...
  SET_VECTOR_ELT(contents, 782, PE1_0);
  ...
  SET_VECTOR_ELT(contents, 783, PE2_0);
  ...
  SET_VECTOR_ELT(contents, 784, prob_asymp);
  ...
  SET_VECTOR_ELT(contents, 785, prob_critical);
  ...
  SET_VECTOR_ELT(contents, 786, prob_critical_death_get_ICU_get_ox_get_MV);
  ...
  SET_VECTOR_ELT(contents, 787, prob_critical_death_get_ICU_get_ox_get_MV_baseline);
  ...
  SET_VECTOR_ELT(contents, 788, prob_critical_death_get_ICU_get_ox_get_MV_Drug_13);
  ...
  SET_VECTOR_ELT(contents, 789, prob_critical_death_get_ICU_get_ox_no_MV);
  ...
  SET_VECTOR_ELT(contents, 790, prob_critical_death_get_ICU_get_ox_no_MV_baseline);
  ...
  SET_VECTOR_ELT(contents, 791, prob_critical_death_get_ICU_get_ox_no_MV_Drug_13);
  ...
  SET_VECTOR_ELT(contents, 792, prob_critical_death_get_ICU_no_ox_no_MV);
  ...
  SET_VECTOR_ELT(contents, 793, prob_critical_death_get_ICU_no_ox_no_MV_baseline);
  ...
  SET_VECTOR_ELT(contents, 794, prob_critical_death_get_ICU_no_ox_no_MV_Drug_13);
  ...
  SET_VECTOR_ELT(contents, 795, prob_critical_death_no_ICU_no_ox_no_MV);
  ...
  SET_VECTOR_ELT(contents, 796, prob_hosp);
  ...
  SET_VECTOR_ELT(contents, 797, prob_moderate_death_get_hosp_get_ox);
  ...
  SET_VECTOR_ELT(contents, 798, prob_moderate_death_get_hosp_get_ox_baseline);
  ...
  SET_VECTOR_ELT(contents, 799, prob_moderate_death_get_hosp_get_ox_Drug_11);
  ...
  SET_VECTOR_ELT(contents, 800, prob_moderate_death_get_hosp_no_ox);
  ...
  SET_VECTOR_ELT(contents, 801, prob_moderate_death_get_hosp_no_ox_baseline);
  ...
  SET_VECTOR_ELT(contents, 802, prob_moderate_death_get_hosp_no_ox_Drug_11);
  ...
  SET_VECTOR_ELT(contents, 803, prob_moderate_death_no_hosp_no_ox);
  ...
  SET_VECTOR_ELT(contents, 804, prob_severe);
  ...
  SET_VECTOR_ELT(contents, 805, prob_severe_death_get_ICU_get_ox);
  ...
  SET_VECTOR_ELT(contents, 806, prob_severe_death_get_ICU_get_ox_baseline);
  ...
  SET_VECTOR_ELT(contents, 807, prob_severe_death_get_ICU_get_ox_Drug_12);
  ...
  SET_VECTOR_ELT(contents, 808, prob_severe_death_get_ICU_no_ox);
  ...
  SET_VECTOR_ELT(contents, 809, prob_severe_death_get_ICU_no_ox_baseline);
  ...
  SET_VECTOR_ELT(contents, 810, prob_severe_death_get_ICU_no_ox_Drug_12);
  ...
  SET_VECTOR_ELT(contents, 811, prob_severe_death_no_ICU_no_ox);
  ...
  SET_VECTOR_ELT(contents, 812, prop_ox_hosp_beds);
  ...
  SET_VECTOR_ELT(contents, 813, prop_ox_ICU_beds);
  SET_VECTOR_ELT(contents, 814, ScalarReal(internal->prophylactic_drug_timing_1));
  SET_VECTOR_ELT(contents, 815, ScalarReal(internal->prophylactic_drug_timing_2));
  SET_VECTOR_ELT(contents, 816, ScalarReal(internal->prophylactic_drug_wane));
  SET_VECTOR_ELT(contents, 817, ScalarReal(internal->prophylactic_prop_treat));
  SEXP PS_0 = PROTECT(allocVector(REALSXP, internal->dim_PS_0));
  memcpy(REAL(PS_0), internal->PS_0, internal->dim_PS_0 * sizeof(double));
  SET_VECTOR_ELT(contents, 818, PS_0);
  SEXP R_0 = PROTECT(allocVector(REALSXP, internal->dim_R_0));
  memcpy(REAL(R_0), internal->R_0, internal->dim_R_0 * sizeof(double));
  SET_VECTOR_ELT(contents, 819, R_0);
  SET_VECTOR_ELT(contents, 820, ScalarReal(internal->rel_inf_asymp));
  SET_VECTOR_ELT(contents, 821, ScalarReal(internal->rel_inf_mild));
  SEXP S_0 = PROTECT(allocVector(REALSXP, internal->dim_S_0));
  memcpy(REAL(S_0), internal->S_0, internal->dim_S_0 * sizeof(double));
  SET_VECTOR_ELT(contents, 822, S_0);
  ...
  SET_VECTOR_ELT(contents, 825, test_number_req_Hosp);
  ...
  SET_VECTOR_ELT(contents, 826, tt_beta);
  ...
  SET_VECTOR_ELT(contents, 827, tt_hosp_beds);
  ...
  SET_VECTOR_ELT(contents, 828, tt_ICU_beds);
  ...
  SET_VECTOR_ELT(contents, 829, tt_matrix);
  ...
  SET_VECTOR_ELT(contents, 830, tt_prop_ox_hosp_beds);
  ...
  SET_VECTOR_ELT(contents, 831, tt_prop_ox_ICU_beds);
  SEXP nms = PROTECT(allocVector(STRSXP, 832));
  ...
  SET_STRING_ELT(nms, 264, mkChar("dim_prob_hosp"));
  SET_STRING_ELT(nms, 265, mkChar("dim_prob_moderate_death_get_hosp_get_ox"));
  SET_STRING_ELT(nms, 266, mkChar("dim_prob_moderate_death_get_hosp_get_ox_baseline"));
  SET_STRING_ELT(nms, 267, mkChar("dim_prob_moderate_death_get_hosp_get_ox_Drug_11"));
  SET_STRING_ELT(nms, 268, mkChar("dim_prob_moderate_death_get_hosp_no_ox"));
  SET_STRING_ELT(nms, 269, mkChar("dim_prob_moderate_death_get_hosp_no_ox_baseline"));
  SET_STRING_ELT(nms, 270, mkChar("dim_prob_moderate_death_get_hosp_no_ox_Drug_11"));
  SET_STRING_ELT(nms, 271, mkChar("dim_prob_moderate_death_no_hosp_no_ox"));
  SET_STRING_ELT(nms, 272, mkChar("dim_prob_severe"));
  SET_STRING_ELT(nms, 273, mkChar("dim_prob_severe_death_get_ICU_get_ox"));
  SET_STRING_ELT(nms, 274, mkChar("dim_prob_severe_death_get_ICU_get_ox_baseline"));
  SET_STRING_ELT(nms, 275, mkChar("dim_prob_severe_death_get_ICU_get_ox_Drug_12"));
  SET_STRING_ELT(nms, 276, mkChar("dim_prob_severe_death_get_ICU_no_ox"));
  SET_STRING_ELT(nms, 277, mkChar("dim_prob_severe_death_get_ICU_no_ox_baseline"));
  SET_STRING_ELT(nms, 278, mkChar("dim_prob_severe_death_get_ICU_no_ox_Drug_12"));
  SET_STRING_ELT(nms, 279, mkChar("dim_prob_severe_death_no_ICU_no_ox"));
  SET_STRING_ELT(nms, 280, mkChar("dim_prop_ox_hosp_beds"));
  SET_STRING_ELT(nms, 281, mkChar("dim_prop_ox_ICU_beds"));
  SET_STRING_ELT(nms, 282, mkChar("dim_PS"));
  SET_STRING_ELT(nms, 283, mkChar("dim_PS_0"));
  SET_STRING_ELT(nms, 284, mkChar("dim_R"));
  SET_STRING_ELT(nms, 285, mkChar("dim_R_0"));
  SET_STRING_ELT(nms, 286, mkChar("dim_S"));
  SET_STRING_ELT(nms, 287, mkChar("dim_S_0"));
  SET_STRING_ELT(nms, 288, mkChar("dim_s_ij"));
  SET_STRING_ELT(nms, 289, mkChar("dim_s_ij_1"));
  SET_STRING_ELT(nms, 290, mkChar("dim_s_ij_2"));
  SET_STRING_ELT(nms, 291, mkChar("dim_temp"));
  SET_STRING_ELT(nms, 292, mkChar("dim_test_number_req_Hosp"));
  SET_STRING_ELT(nms, 293, mkChar("dim_tt_beta"));
  SET_STRING_ELT(nms, 294, mkChar("dim_tt_hosp_beds"));
  SET_STRING_ELT(nms, 295, mkChar("dim_tt_ICU_beds"));
  SET_STRING_ELT(nms, 296, mkChar("dim_tt_matrix"));
  SET_STRING_ELT(nms, 297, mkChar("dim_tt_prop_ox_hosp_beds"));
  SET_STRING_ELT(nms, 298, mkChar("dim_tt_prop_ox_ICU_beds"));
  SET_STRING_ELT(nms, 299, mkChar("drug_1_effect_size"));
  SET_STRING_ELT(nms, 300, mkChar("drug_1_indic"));
  SET_STRING_ELT(nms, 301, mkChar("drug_10_GetOx_GetMV_effect_size"));
  SET_STRING_ELT(nms, 302, mkChar("drug_10_GetOx_NoMV_effect_size"));
  SET_STRING_ELT(nms, 303, mkChar("drug_10_indic_ICrit_GetICU_GetOx_GetMV"));
  SET_STRING_ELT(nms, 304, mkChar("drug_10_indic_ICrit_GetICU_GetOx_NoMV"));
  SET_STRING_ELT(nms, 305, mkChar("drug_10_indic_ICrit_GetICU_NoOx_NoMV"));
  SET_STRING_ELT(nms, 306, mkChar("drug_10_NoOx_NoMV_effect_size"));
  SET_STRING_ELT(nms, 307, mkChar("drug_10_prop_treat"));
  SET_STRING_ELT(nms, 308, mkChar("drug_11_GetOx_effect_size"));
  SET_STRING_ELT(nms, 309, mkChar("drug_11_indic_IMod_GetHosp_GetOx"));
  SET_STRING_ELT(nms, 310, mkChar("drug_11_indic_IMod_GetHosp_NoOx"));
  SET_STRING_ELT(nms, 311, mkChar("drug_11_NoOx_effect_size"));
  SET_STRING_ELT(nms, 312, mkChar("drug_11_prop_treat"));
  SET_STRING_ELT(nms, 313, mkChar("drug_12_GetOx_effect_size"));
  SET_STRING_ELT(nms, 314, mkChar("drug_12_indic_ISev_GetICU_GetOx"));
  SET_STRING_ELT(nms, 315, mkChar("drug_12_indic_ISev_GetICU_NoOx"));
  SET_STRING_ELT(nms, 316, mkChar("drug_12_NoOx_effect_size"));
  SET_STRING_ELT(nms, 317, mkChar("drug_12_prop_treat"));
  SET_STRING_ELT(nms, 318, mkChar("drug_13_GetOx_GetMV_effect_size"));
  SET_STRING_ELT(nms, 319, mkChar("drug_13_GetOx_NoMV_effect_size"));
  SET_STRING_ELT(nms, 320, mkChar("drug_13_indic_ICrit_GetICU_GetOx_GetMV"));
  SET_STRING_ELT(nms, 321, mkChar("drug_13_indic_ICrit_GetICU_GetOx_NoMV"));
  SET_STRING_ELT(nms, 322, mkChar("drug_13_indic_ICrit_GetICU_NoOx_NoMV"));
  SET_STRING_ELT(nms, 323, mkChar("drug_13_NoOx_NoMV_effect_size"));
  SET_STRING_ELT(nms, 324, mkChar("drug_13_prop_treat"));
  SET_STRING_ELT(nms, 325, mkChar("drug_2_effect_size_IPreAsymp"));
  SET_STRING_ELT(nms, 326, mkChar("drug_2_effect_size_IPreCase"));
  SET_STRING_ELT(nms, 327, mkChar("drug_2_effect_size_IPreMild"));
  SET_STRING_ELT(nms, 328, mkChar("drug_2_indic_IPreAsymp"));
  SET_STRING_ELT(nms, 329, mkChar("drug_2_indic_IPreCase"));
  SET_STRING_ELT(nms, 330, mkChar("drug_2_indic_IPreMild"));
  SET_STRING_ELT(nms, 331, mkChar("drug_2_prop_treat"));
  SET_STRING_ELT(nms, 332, mkChar("drug_3_effect_size"));
  SET_STRING_ELT(nms, 333, mkChar("drug_3_indic"));
  SET_STRING_ELT(nms, 334, mkChar("drug_3_prop_treat"));
  SET_STRING_ELT(nms, 335, mkChar("drug_4_effect_size_IAsymp"));
  SET_STRING_ELT(nms, 336, mkChar("drug_4_effect_size_ICase"));
  SET_STRING_ELT(nms, 337, mkChar("drug_4_effect_size_IMild"));
  SET_STRING_ELT(nms, 338, mkChar("drug_4_indic_IAsymp"));
  SET_STRING_ELT(nms, 339, mkChar("drug_4_indic_ICase"));
  SET_STRING_ELT(nms, 340, mkChar("drug_4_indic_IMild"));
  SET_STRING_ELT(nms, 341, mkChar("drug_4_prop_treat"));
  SET_STRING_ELT(nms, 342, mkChar("drug_5_effect_size"));
  SET_STRING_ELT(nms, 343, mkChar("drug_5_indic_ICase"));
  SET_STRING_ELT(nms, 344, mkChar("drug_5_indic_IMild"));
  SET_STRING_ELT(nms, 345, mkChar("drug_5_prop_treat"));
  SET_STRING_ELT(nms, 346, mkChar("drug_6_effect_size"));
  SET_STRING_ELT(nms, 347, mkChar("drug_6_indic"));
  SET_STRING_ELT(nms, 348, mkChar("drug_6_prop_treat"));
  SET_STRING_ELT(nms, 349, mkChar("drug_7_effect_size"));
  SET_STRING_ELT(nms, 350, mkChar("drug_7_indic"));
  SET_STRING_ELT(nms, 351, mkChar("drug_7_prop_treat"));
  SET_STRING_ELT(nms, 352, mkChar("drug_8_GetOx_effect_size"));
  SET_STRING_ELT(nms, 353, mkChar("drug_8_indic_IMod_GetHosp_GetOx"));
  SET_STRING_ELT(nms, 354, mkChar("drug_8_indic_IMod_GetHosp_NoOx"));
  SET_STRING_ELT(nms, 355, mkChar("drug_8_NoOx_effect_size"));
  SET_STRING_ELT(nms, 356, mkChar("drug_8_prop_treat"));
  SET_STRING_ELT(nms, 357, mkChar("drug_9_GetOx_effect_size"));
  SET_STRING_ELT(nms, 358, mkChar("drug_9_indic_ISev_GetICU_GetOx"));
  SET_STRING_ELT(nms, 359, mkChar("drug_9_indic_ISev_GetICU_NoOx"));
  SET_STRING_ELT(nms, 360, mkChar("drug_9_NoOx_effect_size"));
  SET_STRING_ELT(nms, 361, mkChar("drug_9_prop_treat"));
  SET_STRING_ELT(nms, 362, mkChar("E1_0"));
  SET_STRING_ELT(nms, 363, mkChar("E2_0"));
  SET_STRING_ELT(nms, 364, mkChar("gamma_E"));
  SET_STRING_ELT(nms, 365, mkChar("gamma_IAsymp"));
  SET_STRING_ELT(nms, 366, mkChar("gamma_IAsymp_Drug_4"));
  SET_STRING_ELT(nms, 367, mkChar("gamma_ICase"));
  SET_STRING_ELT(nms, 368, mkChar("gamma_ICase_Drug_4"));
  SET_STRING_ELT(nms, 369, mkChar("gamma_ICrit_GetICU_GetOx_GetMV_Die"));
  SET_STRING_ELT(nms, 370, mkChar("gamma_ICrit_GetICU_GetOx_GetMV_Surv"));
  SET_STRING_ELT(nms, 371, mkChar("gamma_ICrit_GetICU_GetOx_GetMV_Surv_Drug_10"));
  SET_STRING_ELT(nms, 372, mkChar("gamma_ICrit_GetICU_GetOx_NoMV_Die"));
  SET_STRING_ELT(nms, 373, mkChar("gamma_ICrit_GetICU_GetOx_NoMV_Surv"));
  SET_STRING_ELT(nms, 374, mkChar("gamma_ICrit_GetICU_GetOx_NoMV_Surv_Drug_10"));
  SET_STRING_ELT(nms, 375, mkChar("gamma_ICrit_GetICU_NoOx_NoMV_Die"));
  SET_STRING_ELT(nms, 376, mkChar("gamma_ICrit_GetICU_NoOx_NoMV_Surv"));
  SET_STRING_ELT(nms, 377, mkChar("gamma_ICrit_GetICU_NoOx_NoMV_Surv_Drug_10"));
  SET_STRING_ELT(nms, 378, mkChar("gamma_ICrit_NoICU_NoOx_NoMV_Die"));
  SET_STRING_ELT(nms, 379, mkChar("gamma_ICrit_NoICU_NoOx_NoMV_Surv"));
  SET_STRING_ELT(nms, 380, mkChar("gamma_IMild"));
  SET_STRING_ELT(nms, 381, mkChar("gamma_IMild_Drug_4"));
  SET_STRING_ELT(nms, 382, mkChar("gamma_IMod_GetHosp_GetOx_Die"));
  SET_STRING_ELT(nms, 383, mkChar("gamma_IMod_GetHosp_GetOx_Surv"));
  SET_STRING_ELT(nms, 384, mkChar("gamma_IMod_GetHosp_GetOx_Surv_Drug_8"));
  SET_STRING_ELT(nms, 385, mkChar("gamma_IMod_GetHosp_NoOx_Die"));
  SET_STRING_ELT(nms, 386, mkChar("gamma_IMod_GetHosp_NoOx_Surv"));
  SET_STRING_ELT(nms, 387, mkChar("gamma_IMod_GetHosp_NoOx_Surv_Drug_8"));
  SET_STRING_ELT(nms, 388, mkChar("gamma_IMod_NoHosp_NoOx_Die"));
  SET_STRING_ELT(nms, 389, mkChar("gamma_IMod_NoHosp_NoOx_Surv"));
  SET_STRING_ELT(nms, 390, mkChar("gamma_IPreAsymp"));
  SET_STRING_ELT(nms, 391, mkChar("gamma_IPreAsymp_Drug_2"));
  SET_STRING_ELT(nms, 392, mkChar("gamma_IPreCase"));
  SET_STRING_ELT(nms, 393, mkChar("gamma_IPreCase_Drug_2"));
  SET_STRING_ELT(nms, 394, mkChar("gamma_IPreMild"));
  SET_STRING_ELT(nms, 395, mkChar("gamma_IPreMild_Drug_2"));
  SET_STRING_ELT(nms, 396, mkChar("gamma_ISev_GetICU_GetOx_Die"));
  SET_STRING_ELT(nms, 397, mkChar("gamma_ISev_GetICU_GetOx_Surv"));
  SET_STRING_ELT(nms, 398, mkChar("gamma_ISev_GetICU_GetOx_Surv_Drug_9"));
  SET_STRING_ELT(nms, 399, mkChar("gamma_ISev_GetICU_NoOx_Die"));
  SET_STRING_ELT(nms, 400, mkChar("gamma_ISev_GetICU_NoOx_Surv"));
  SET_STRING_ELT(nms, 401, mkChar("gamma_ISev_GetICU_NoOx_Surv_Drug_9"));
  SET_STRING_ELT(nms, 402, mkChar("gamma_ISev_NoICU_NoOx_Die"));
  SET_STRING_ELT(nms, 403, mkChar("gamma_ISev_NoICU_NoOx_Surv"));
  SET_STRING_ELT(nms, 404, mkChar("gamma_rec"));
  SET_STRING_ELT(nms, 405, mkChar("hosp_bed_capacity"));
  SET_STRING_ELT(nms, 406, mkChar("IAsymp_0"));
  SET_STRING_ELT(nms, 407, mkChar("ICase1_0"));
  SET_STRING_ELT(nms, 408, mkChar("ICase1Drug3_0"));
  SET_STRING_ELT(nms, 409, mkChar("ICase2_0"));
  SET_STRING_ELT(nms, 410, mkChar("ICase2Drug3_0"));
  SET_STRING_ELT(nms, 411, mkChar("ICrit_GetICU_GetOx_GetMV_Die1_0"));
  SET_STRING_ELT(nms, 412, mkChar("ICrit_GetICU_GetOx_GetMV_Die2_0"));
  SET_STRING_ELT(nms, 413, mkChar("ICrit_GetICU_GetOx_GetMV_Surv1_0"));
  SET_STRING_ELT(nms, 414, mkChar("ICrit_GetICU_GetOx_GetMV_Surv2_0"));
  SET_STRING_ELT(nms, 415, mkChar("ICrit_GetICU_GetOx_NoMV_Die1_0"));
  SET_STRING_ELT(nms, 416, mkChar("ICrit_GetICU_GetOx_NoMV_Die2_0"));
  SET_STRING_ELT(nms, 417, mkChar("ICrit_GetICU_GetOx_NoMV_Surv1_0"));
  SET_STRING_ELT(nms, 418, mkChar("ICrit_GetICU_GetOx_NoMV_Surv2_0"));
  SET_STRING_ELT(nms, 419, mkChar("ICrit_GetICU_NoOx_NoMV_Die1_0"));
  SET_STRING_ELT(nms, 420, mkChar("ICrit_GetICU_NoOx_NoMV_Die2_0"));
  SET_STRING_ELT(nms, 421, mkChar("ICrit_GetICU_NoOx_NoMV_Surv1_0"));
  SET_STRING_ELT(nms, 422, mkChar("ICrit_GetICU_NoOx_NoMV_Surv2_0"));
  SET_STRING_ELT(nms, 423, mkChar("ICrit_NoICU_NoOx_NoMV_Die1_0"));
  SET_STRING_ELT(nms, 424, mkChar("ICrit_NoICU_NoOx_NoMV_Die2_0"));
  SET_STRING_ELT(nms, 425, mkChar("ICrit_NoICU_NoOx_NoMV_Surv1_0"));
  SET_STRING_ELT(nms, 426, mkChar("ICrit_NoICU_NoOx_NoMV_Surv2_0"));
  SET_STRING_ELT(nms, 427, mkChar("ICU_bed_capacity"));
  SET_STRING_ELT(nms, 428, mkChar("IMild_0"));
  SET_STRING_ELT(nms, 429, mkChar("IMod_GetHosp_GetOx_Die1_0"));
  SET_STRING_ELT(nms, 430, mkChar("IMod_GetHosp_GetOx_Die2_0"));
  SET_STRING_ELT(nms, 431, mkChar("IMod_GetHosp_GetOx_Surv1_0"));
  SET_STRING_ELT(nms, 432, mkChar("IMod_GetHosp_GetOx_Surv2_0"));
  SET_STRING_ELT(nms, 433, mkChar("IMod_GetHosp_NoOx_Die1_0"));
  SET_STRING_ELT(nms, 434, mkChar("IMod_GetHosp_NoOx_Die2_0"));
  SET_STRING_ELT(nms, 435, mkChar("IMod_GetHosp_NoOx_Surv1_0"));
  SET_STRING_ELT(nms, 436, mkChar("IMod_GetHosp_NoOx_Surv2_0"));
  SET_STRING_ELT(nms, 437, mkChar("IMod_NoHosp_NoOx_Die1_0"));
  SET_STRING_ELT(nms, 438, mkChar("IMod_NoHosp_NoOx_Die2_0"));
  SET_STRING_ELT(nms, 439, mkChar("IMod_NoHosp_NoOx_Surv1_0"));
  SET_STRING_ELT(nms, 440, mkChar("IMod_NoHosp_NoOx_Surv2_0"));
  SET_STRING_ELT(nms, 441, mkChar("initial_D"));
  SET_STRING_ELT(nms, 442, mkChar("initial_D_Community"));
  SET_STRING_ELT(nms, 443, mkChar("initial_D_Hospital"));
  SET_STRING_ELT(nms, 444, mkChar("initial_E1"));
  SET_STRING_ELT(nms, 445, mkChar("initial_E2"));
  SET_STRING_ELT(nms, 446, mkChar("initial_IAsymp"));
  SET_STRING_ELT(nms, 447, mkChar("initial_ICase1"));
  SET_STRING_ELT(nms, 448, mkChar("initial_ICase1Drug3"));
  SET_STRING_ELT(nms, 449, mkChar("initial_ICase2"));
  SET_STRING_ELT(nms, 450, mkChar("initial_ICase2Drug3"));
  SET_STRING_ELT(nms, 451, mkChar("initial_ICrit_GetICU_GetOx_GetMV_Die1"));
  SET_STRING_ELT(nms, 452, mkChar("initial_ICrit_GetICU_GetOx_GetMV_Die2"));
  SET_STRING_ELT(nms, 453, mkChar("initial_ICrit_GetICU_GetOx_GetMV_Surv1"));
  SET_STRING_ELT(nms, 454, mkChar("initial_ICrit_GetICU_GetOx_GetMV_Surv2"));
  SET_STRING_ELT(nms, 455, mkChar("initial_ICrit_GetICU_GetOx_NoMV_Die1"));
  SET_STRING_ELT(nms, 456, mkChar("initial_ICrit_GetICU_GetOx_NoMV_Die2"));
  SET_STRING_ELT(nms, 457, mkChar("initial_ICrit_GetICU_GetOx_NoMV_Surv1"));
  SET_STRING_ELT(nms, 458, mkChar("initial_ICrit_GetICU_GetOx_NoMV_Surv2"));
  SET_STRING_ELT(nms, 459, mkChar("initial_ICrit_GetICU_NoOx_NoMV_Die1"));
  SET_STRING_ELT(nms, 460, mkChar("initial_ICrit_GetICU_NoOx_NoMV_Die2"));
  SET_STRING_ELT(nms, 461, mkChar("initial_ICrit_GetICU_NoOx_NoMV_Surv1"));
  SET_STRING_ELT(nms, 462, mkChar("initial_ICrit_GetICU_NoOx_NoMV_Surv2"));
  SET_STRING_ELT(nms, 463, mkChar("initial_ICrit_NoICU_NoOx_NoMV_Die1"));
  SET_STRING_ELT(nms, 464, mkChar("initial_ICrit_NoICU_NoOx_NoMV_Die2"));
  SET_STRING_ELT(nms, 465, mkChar("initial_ICrit_NoICU_NoOx_NoMV_Surv1"));
  SET_STRING_ELT(nms, 466, mkChar("initial_ICrit_NoICU_NoOx_NoMV_Surv2"));
  SET_STRING_ELT(nms, 467, mkChar("initial_IMild"));
  SET_STRING_ELT(nms, 468, mkChar("initial_IMod_GetHosp_GetOx_Die1"));
  SET_STRING_ELT(nms, 469, mkChar("initial_IMod_GetHosp_GetOx_Die2"));
  SET_STRING_ELT(nms, 470, mkChar("initial_IMod_GetHosp_GetOx_Surv1"));
  SET_STRING_ELT(nms, 471, mkChar("initial_IMod_GetHosp_GetOx_Surv2"));
  SET_STRING_ELT(nms, 472, mkChar("initial_IMod_GetHosp_NoOx_Die1"));
  SET_STRING_ELT(nms, 473, mkChar("initial_IMod_GetHosp_NoOx_Die2"));
  SET_STRING_ELT(nms, 474, mkChar("initial_IMod_GetHosp_NoOx_Surv1"));
  SET_STRING_ELT(nms, 475, mkChar("initial_IMod_GetHosp_NoOx_Surv2"));
  SET_STRING_ELT(nms, 476, mkChar("initial_IMod_NoHosp_NoOx_Die1"));
  SET_STRING_ELT(nms, 477, mkChar("initial_IMod_NoHosp_NoOx_Die2"));
  SET_STRING_ELT(nms, 478, mkChar("initial_IMod_NoHosp_NoOx_Surv1"));
  SET_STRING_ELT(nms, 479, mkChar("initial_IMod_NoHosp_NoOx_Surv2"));
  SET_STRING_ELT(nms, 480, mkChar("initial_IPre1Asymp"));
  SET_STRING_ELT(nms, 481, mkChar("initial_IPre1Case"));
  SET_STRING_ELT(nms, 482, mkChar("initial_IPre1CaseDrug3"));
  SET_STRING_ELT(nms, 483, mkChar("initial_IPre1Mild"));
  SET_STRING_ELT(nms, 484, mkChar("initial_IPre2Asymp"));
  SET_STRING_ELT(nms, 485, mkChar("initial_IPre2Case"));
  SET_STRING_ELT(nms, 486, mkChar("initial_IPre2CaseDrug3"));
  SET_STRING_ELT(nms, 487, mkChar("initial_IPre2Mild"));
  SET_STRING_ELT(nms, 488, mkChar("initial_IRec1"));
  SET_STRING_ELT(nms, 489, mkChar("initial_IRec2"));
  SET_STRING_ELT(nms, 490, mkChar("initial_ISev_GetICU_GetOx_Die1"));
  SET_STRING_ELT(nms, 491, mkChar("initial_ISev_GetICU_GetOx_Die2"));
  SET_STRING_ELT(nms, 492, mkChar("initial_ISev_GetICU_GetOx_Surv1"));
  SET_STRING_ELT(nms, 493, mkChar("initial_ISev_GetICU_GetOx_Surv2"));
  SET_STRING_ELT(nms, 494, mkChar("initial_ISev_GetICU_NoOx_Die1"));
  SET_STRING_ELT(nms, 495, mkChar("initial_ISev_GetICU_NoOx_Die2"));
  SET_STRING_ELT(nms, 496, mkChar("initial_ISev_GetICU_NoOx_Surv1"));
  SET_STRING_ELT(nms, 497, mkChar("initial_ISev_GetICU_NoOx_Surv2"));
  SET_STRING_ELT(nms, 498, mkChar("initial_ISev_NoICU_NoOx_Die1"));
  SET_STRING_ELT(nms, 499, mkChar("initial_ISev_NoICU_NoOx_Die2"));
  SET_STRING_ELT(nms, 500, mkChar("initial_ISev_NoICU_NoOx_Surv1"));
  SET_STRING_ELT(nms, 501, mkChar("initial_ISev_NoICU_NoOx_Surv2"));
  SET_STRING_ELT(nms, 502, mkChar("initial_PE1"));
  SET_STRING_ELT(nms, 503, mkChar("initial_PE2"));
  SET_STRING_ELT(nms, 504, mkChar("initial_PS"));
  SET_STRING_ELT(nms, 505, mkChar("initial_R"));
  SET_STRING_ELT(nms, 506, mkChar("initial_S"));
  SET_STRING_ELT(nms, 507, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 508, mkChar("interpolate_current_hosp_bed_capacity"));
  SET_STRING_ELT(nms, 509, mkChar("interpolate_current_ICU_bed_capacity"));
  SET_STRING_ELT(nms, 510, mkChar("interpolate_current_prop_ox_hosp_beds"));
  SET_STRING_ELT(nms, 511, mkChar("interpolate_current_prop_ox_ICU_beds"));
  SET_STRING_ELT(nms, 512, mkChar("interpolate_m"));
  SET_STRING_ELT(nms, 513, mkChar("IPre1Asymp_0"));
  SET_STRING_ELT(nms, 514, mkChar("IPre1Case_0"));
  SET_STRING_ELT(nms, 515, mkChar("IPre1CaseDrug3_0"));
  SET_STRING_ELT(nms, 516, mkChar("IPre1Mild_0"));
  SET_STRING_ELT(nms, 517, mkChar("IPre2Asymp_0"));
  SET_STRING_ELT(nms, 518, mkChar("IPre2Case_0"));
  SET_STRING_ELT(nms, 519, mkChar("IPre2CaseDrug3_0"));
  SET_STRING_ELT(nms, 520, mkChar("IPre2Mild_0"));
  SET_STRING_ELT(nms, 521, mkChar("IRec1_0"));
  SET_STRING_ELT(nms, 522, mkChar("IRec2_0"));
  SET_STRING_ELT(nms, 523, mkChar("ISev_GetICU_GetOx_Die1_0"));
  SET_STRING_ELT(nms, 524, mkChar("ISev_GetICU_GetOx_Die2_0"));
  SET_STRING_ELT(nms, 525, mkChar("ISev_GetICU_GetOx_Surv1_0"));
  SET_STRING_ELT(nms, 526, mkChar("ISev_GetICU_GetOx_Surv2_0"));
  SET_STRING_ELT(nms, 527, mkChar("ISev_GetICU_NoOx_Die1_0"));
  SET_STRING_ELT(nms, 528, mkChar("ISev_GetICU_NoOx_Die2_0"));
  SET_STRING_ELT(nms, 529, mkChar("ISev_GetICU_NoOx_Surv1_0"));
  SET_STRING_ELT(nms, 530, mkChar("ISev_GetICU_NoOx_Surv2_0"));
  SET_STRING_ELT(nms, 531, mkChar("ISev_NoICU_NoOx_Die1_0"));
  SET_STRING_ELT(nms, 532, mkChar("ISev_NoICU_NoOx_Die2_0"));
  SET_STRING_ELT(nms, 533, mkChar("ISev_NoICU_NoOx_Surv1_0"));
  SET_STRING_ELT(nms, 534, mkChar("ISev_NoICU_NoOx_Surv2_0"));
  SET_STRING_ELT(nms, 535, mkChar("lambda"));
  SET_STRING_ELT(nms, 536, mkChar("m"));
  SET_STRING_ELT(nms, 537, mkChar("mix_mat_set"));
  SET_STRING_ELT(nms, 538, mkChar("MV_capacity"));
  SET_STRING_ELT(nms, 539, mkChar("N_age"));
  SET_STRING_ELT(nms, 540, mkChar("n_E1_E2"));
  SET_STRING_ELT(nms, 541, mkChar("n_E2_IPre"));
  SET_STRING_ELT(nms, 542, mkChar("n_E2_IPre1Asymp"));
  SET_STRING_ELT(nms, 543, mkChar("n_E2_IPre1ICase"));
  SET_STRING_ELT(nms, 544, mkChar("n_E2_IPre1ICase_initial"));
  SET_STRING_ELT(nms, 545, mkChar("n_E2_IPre1ICaseDrug3"));
  SET_STRING_ELT(nms, 546, mkChar("n_E2_IPre1Mild"));
  SET_STRING_ELT(nms, 547, mkChar("n_E2_IPre1Mild_or_IPre1Asymp"));
  SET_STRING_ELT(nms, 548, mkChar("n_IAsymp_R"));
  SET_STRING_ELT(nms, 549, mkChar("n_ICase1_ICase2"));
  SET_STRING_ELT(nms, 550, mkChar("n_ICase1Drug3_ICase2Drug3"));
  SET_STRING_ELT(nms, 551, mkChar("n_ICase2_Hosp"));
  SET_STRING_ELT(nms, 552, mkChar("n_ICase2Drug3_R"));
  SET_STRING_ELT(nms, 553, mkChar("n_ICrit_GetICU_GetOx_GetMV_Die1"));
  SET_STRING_ELT(nms, 554, mkChar("n_ICrit_GetICU_GetOx_GetMV_Die1_ICrit_GetICU_GetOx_GetMV_Die2"));
  SET_STRING_ELT(nms, 555, mkChar("n_ICrit_GetICU_GetOx_GetMV_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 556, mkChar("n_ICrit_GetICU_GetOx_GetMV_Surv1"));
  SET_STRING_ELT(nms, 557, mkChar("n_ICrit_GetICU_GetOx_GetMV_Surv1_ICrit_GetICU_GetOx_GetMV_Surv2"));
  SET_STRING_ELT(nms, 558, mkChar("n_ICrit_GetICU_GetOx_GetMV_Surv2_Rec"));
  SET_STRING_ELT(nms, 559, mkChar("n_ICrit_GetICU_GetOx_NoMV_Die1"));
  SET_STRING_ELT(nms, 560, mkChar("n_ICrit_GetICU_GetOx_NoMV_Die1_ICrit_GetICU_GetOx_NoMV_Die2"));
  SET_STRING_ELT(nms, 561, mkChar("n_ICrit_GetICU_GetOx_NoMV_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 562, mkChar("n_ICrit_GetICU_GetOx_NoMV_Surv1"));
  SET_STRING_ELT(nms, 563, mkChar("n_ICrit_GetICU_GetOx_NoMV_Surv1_ICrit_GetICU_GetOx_NoMV_Surv2"));
  SET_STRING_ELT(nms, 564, mkChar("n_ICrit_GetICU_GetOx_NoMV_Surv2_Rec"));
  SET_STRING_ELT(nms, 565, mkChar("n_ICrit_GetICU_NoOx_NoMV_Die1"));
  SET_STRING_ELT(nms, 566, mkChar("n_ICrit_GetICU_NoOx_NoMV_Die1_ICrit_GetICU_NoOx_NoMV_Die2"));
  SET_STRING_ELT(nms, 567, mkChar("n_ICrit_GetICU_NoOx_NoMV_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 568, mkChar("n_ICrit_GetICU_NoOx_NoMV_Surv1"));
  SET_STRING_ELT(nms, 569, mkChar("n_ICrit_GetICU_NoOx_NoMV_Surv1_ICrit_GetICU_NoOx_NoMV_Surv2"));
  SET_STRING_ELT(nms, 570, mkChar("n_ICrit_GetICU_NoOx_NoMV_Surv2_Rec"));
  SET_STRING_ELT(nms, 571, mkChar("n_ICrit_NoICU_NoOx_NoMV_Die1"));
  SET_STRING_ELT(nms, 572, mkChar("n_ICrit_NoICU_NoOx_NoMV_Die1_ICrit_NoICU_NoOx_NoMV_Die2"));
  SET_STRING_ELT(nms, 573, mkChar("n_ICrit_NoICU_NoOx_NoMV_Die2_D_Community"));
  SET_STRING_ELT(nms, 574, mkChar("n_ICrit_NoICU_NoOx_NoMV_Surv1"));
  SET_STRING_ELT(nms, 575, mkChar("n_ICrit_NoICU_NoOx_NoMV_Surv1_ICrit_NoICU_NoOx_NoMV_Surv2"));
  SET_STRING_ELT(nms, 576, mkChar("n_ICrit_NoICU_NoOx_NoMV_Surv2_R"));
  SET_STRING_ELT(nms, 577, mkChar("n_IMild_R"));
  SET_STRING_ELT(nms, 578, mkChar("n_IMod_GetHosp_GetOx_Die1"));
  SET_STRING_ELT(nms, 579, mkChar("n_IMod_GetHosp_GetOx_Die1_IMod_GetHosp_GetOx_Die2"));
  SET_STRING_ELT(nms, 580, mkChar("n_IMod_GetHosp_GetOx_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 581, mkChar("n_IMod_GetHosp_GetOx_Surv1"));
  SET_STRING_ELT(nms, 582, mkChar("n_IMod_GetHosp_GetOx_Surv1_IMod_GetHosp_GetOx_Surv2"));
  SET_STRING_ELT(nms, 583, mkChar("n_IMod_GetHosp_GetOx_Surv2_R"));
  SET_STRING_ELT(nms, 584, mkChar("n_IMod_GetHosp_NoOx_Die1"));
  SET_STRING_ELT(nms, 585, mkChar("n_IMod_GetHosp_NoOx_Die1_IMod_GetHosp_NoOx_Die2"));
  SET_STRING_ELT(nms, 586, mkChar("n_IMod_GetHosp_NoOx_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 587, mkChar("n_IMod_GetHosp_NoOx_Surv1"));
  SET_STRING_ELT(nms, 588, mkChar("n_IMod_GetHosp_NoOx_Surv1_IMod_GetHosp_NoOx_Surv2"));
  SET_STRING_ELT(nms, 589, mkChar("n_IMod_GetHosp_NoOx_Surv2_R"));
  SET_STRING_ELT(nms, 590, mkChar("n_IMod_NoHosp_NoOx_Die1"));
  SET_STRING_ELT(nms, 591, mkChar("n_IMod_NoHosp_NoOx_Die1_IMod_NoHosp_NoOx_Die2"));
  SET_STRING_ELT(nms, 592, mkChar("n_IMod_NoHosp_NoOx_Die2_D_Community"));
  SET_STRING_ELT(nms, 593, mkChar("n_IMod_NoHosp_NoOx_Surv1"));
  SET_STRING_ELT(nms, 594, mkChar("n_IMod_NoHosp_NoOx_Surv1_IMod_NoHosp_NoOx_Surv2"));
  SET_STRING_ELT(nms, 595, mkChar("n_IMod_NoHosp_NoOx_Surv2_R"));
  SET_STRING_ELT(nms, 596, mkChar("n_IPre1_Asymp_IPre2_Asymp"));
  SET_STRING_ELT(nms, 597, mkChar("n_IPre1_Case_IPre2_Case"));
  SET_STRING_ELT(nms, 598, mkChar("n_IPre1_CaseDrug3_IPre2_CaseDrug3"));
  SET_STRING_ELT(nms, 599, mkChar("n_IPre1_Mild_IPre2_Mild"));
  SET_STRING_ELT(nms, 600, mkChar("n_IPre2_Asymp_IAsymp"));
  SET_STRING_ELT(nms, 601, mkChar("n_IPre2_Case_ICase1"));
  SET_STRING_ELT(nms, 602, mkChar("n_IPre2_CaseDrug3_ICase1Drug3"));
  SET_STRING_ELT(nms, 603, mkChar("n_IPre2_Mild_IMild"));
  SET_STRING_ELT(nms, 604, mkChar("n_IRec1_IRec2"));
  SET_STRING_ELT(nms, 605, mkChar("n_IRec2_R"));
  SET_STRING_ELT(nms, 606, mkChar("n_ISev_GetICU_GetOx_Die1"));
  SET_STRING_ELT(nms, 607, mkChar("n_ISev_GetICU_GetOx_Die1_ISev_GetICU_GetOx_Die2"));
  SET_STRING_ELT(nms, 608, mkChar("n_ISev_GetICU_GetOx_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 609, mkChar("n_ISev_GetICU_GetOx_Surv1"));
  SET_STRING_ELT(nms, 610, mkChar("n_ISev_GetICU_GetOx_Surv1_ISev_GetICU_GetOx_Surv2"));
  SET_STRING_ELT(nms, 611, mkChar("n_ISev_GetICU_GetOx_Surv2_Rec"));
  SET_STRING_ELT(nms, 612, mkChar("n_ISev_GetICU_NoOx_Die1"));
  SET_STRING_ELT(nms, 613, mkChar("n_ISev_GetICU_NoOx_Die1_ISev_GetICU_NoOx_Die2"));
  SET_STRING_ELT(nms, 614, mkChar("n_ISev_GetICU_NoOx_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 615, mkChar("n_ISev_GetICU_NoOx_Surv1"));
  SET_STRING_ELT(nms, 616, mkChar("n_ISev_GetICU_NoOx_Surv1_ISev_GetICU_NoOx_Surv2"));
  SET_STRING_ELT(nms, 617, mkChar("n_ISev_GetICU_NoOx_Surv2_Rec"));
  SET_STRING_ELT(nms, 618, mkChar("n_ISev_NoICU_NoOx_Die1"));
  SET_STRING_ELT(nms, 619, mkChar("n_ISev_NoICU_NoOx_Die1_ISev_NoICU_NoOx_Die2"));
  SET_STRING_ELT(nms, 620, mkChar("n_ISev_NoICU_NoOx_Die2_D_Community"));
  SET_STRING_ELT(nms, 621, mkChar("n_ISev_NoICU_NoOx_Surv1"));
  SET_STRING_ELT(nms, 622, mkChar("n_ISev_NoICU_NoOx_Surv1_ISev_NoICU_NoOx_Surv2"));
  SET_STRING_ELT(nms, 623, mkChar("n_ISev_NoICU_NoOx_Surv2_R"));
  SET_STRING_ELT(nms, 624, mkChar("n_PE1_PE2"));
  SET_STRING_ELT(nms, 625, mkChar("n_PE2_IPre"));
  SET_STRING_ELT(nms, 626, mkChar("n_PS_PE1"));
  SET_STRING_ELT(nms, 627, mkChar("n_PS_S"));
  SET_STRING_ELT(nms, 628, mkChar("n_S_E1"));
  SET_STRING_ELT(nms, 629, mkChar("n_S_PS"));
  SET_STRING_ELT(nms, 630, mkChar("number_GetICU_GetOx"));
  SET_STRING_ELT(nms, 631, mkChar("number_GetICU_GetOx_to_IMod"));
  SET_STRING_ELT(nms, 632, mkChar("number_GetICU_NoOx"));
  SET_STRING_ELT(nms, 633, mkChar("number_GetICU_NoOx_to_IMod"));
  SET_STRING_ELT(nms, 634, mkChar("number_ICrit_GetICU_GetOx"));
  SET_STRING_ELT(nms, 635, mkChar("number_ICrit_GetICU_GetOx_GetMV"));
  SET_STRING_ELT(nms, 636, mkChar("number_ICrit_GetICU_GetOx_initial"));
  SET_STRING_ELT(nms, 637, mkChar("number_ICrit_GetICU_GetOx_NoMV"));
  SET_STRING_ELT(nms, 638, mkChar("number_ICrit_GetICU_NoOx_NoMV"));
  SET_STRING_ELT(nms, 639, mkChar("number_ICrit_GetICU_NoOx_NoMV_initial"));
  SET_STRING_ELT(nms, 640, mkChar("number_ICrit_NoICU_NoOx_NoMV"));
  SET_STRING_ELT(nms, 641, mkChar("number_IMod_GetHosp_GetOx"));
  SET_STRING_ELT(nms, 642, mkChar("number_IMod_GetHosp_NoOx"));
  SET_STRING_ELT(nms, 643, mkChar("number_IMod_NoHosp_NoOx"));
  SET_STRING_ELT(nms, 644, mkChar("number_ISev_GetICU_GetOx"));
  SET_STRING_ELT(nms, 645, mkChar("number_ISev_GetICU_NoOx"));
  SET_STRING_ELT(nms, 646, mkChar("number_ISev_NoICU_NoOx"));
  SET_STRING_ELT(nms, 647, mkChar("number_NoICU"));
  SET_STRING_ELT(nms, 648, mkChar("number_req_Hosp"));
  SET_STRING_ELT(nms, 649, mkChar("number_req_hosp_remaining"));
  SET_STRING_ELT(nms, 650, mkChar("number_req_ICU"));
  SET_STRING_ELT(nms, 651, mkChar("number_req_ICU_remaining"));
  SET_STRING_ELT(nms, 652, mkChar("offset_output_n_E2_IPre"));
  SET_STRING_ELT(nms, 653, mkChar("offset_output_n_E2_IPre1ICase"));
  SET_STRING_ELT(nms, 654, mkChar("offset_output_n_ICase2_Hosp"));
  SET_STRING_ELT(nms, 655, mkChar("offset_output_n_ICrit_GetICU_GetOx_GetMV_Surv1"));
  SET_STRING_ELT(nms, 656, mkChar("offset_output_n_ICrit_GetICU_GetOx_GetMV_Surv1_ICrit_GetICU_GetOx_GetMV_Surv2"));
  SET_STRING_ELT(nms, 657, mkChar("offset_output_n_ICrit_GetICU_GetOx_GetMV_Surv2_Rec"));
  SET_STRING_ELT(nms, 658, mkChar("offset_output_n_ICrit_GetICU_GetOx_NoMV_Surv2_Rec"));
  SET_STRING_ELT(nms, 659, mkChar("offset_output_n_ICrit_GetICU_NoOx_NoMV_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 660, mkChar("offset_output_n_ICrit_GetICU_NoOx_NoMV_Surv2_Rec"));
  SET_STRING_ELT(nms, 661, mkChar("offset_output_n_IMod_GetHosp_GetOx_Die1"));
  SET_STRING_ELT(nms, 662, mkChar("offset_output_n_IMod_GetHosp_GetOx_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 663, mkChar("offset_output_n_IMod_GetHosp_GetOx_Surv2_R"));
  SET_STRING_ELT(nms, 664, mkChar("offset_output_n_IMod_GetHosp_NoOx_Die1"));
  SET_STRING_ELT(nms, 665, mkChar("offset_output_n_IMod_GetHosp_NoOx_Surv2_R"));
  SET_STRING_ELT(nms, 666, mkChar("offset_output_n_IMod_NoHosp_NoOx_Die1"));
  SET_STRING_ELT(nms, 667, mkChar("offset_output_n_ISev_GetICU_GetOx_Die1"));
  SET_STRING_ELT(nms, 668, mkChar("offset_output_n_ISev_GetICU_GetOx_Surv1"));
  SET_STRING_ELT(nms, 669, mkChar("offset_output_n_ISev_GetICU_GetOx_Surv1_ISev_GetICU_GetOx_Surv2"));
  SET_STRING_ELT(nms, 670, mkChar("offset_output_n_ISev_GetICU_GetOx_Surv2_Rec"));
  SET_STRING_ELT(nms, 671, mkChar("offset_output_n_ISev_GetICU_NoOx_Die2_D_Hospital"));
  SET_STRING_ELT(nms, 672, mkChar("offset_output_n_ISev_GetICU_NoOx_Surv2_Rec"));
  SET_STRING_ELT(nms, 673, mkChar("offset_output_n_PE1_PE2"));
  SET_STRING_ELT(nms, 674, mkChar("offset_output_n_PS_PE1"));
  SET_STRING_ELT(nms, 675, mkChar("offset_output_n_PS_S"));
  SET_STRING_ELT(nms, 676, mkChar("offset_output_n_S_PS"));
  SET_STRING_ELT(nms, 677, mkChar("offset_output_number_GetICU_GetOx"));
  SET_STRING_ELT(nms, 678, mkChar("offset_output_number_GetICU_GetOx_to_IMod"));
  SET_STRING_ELT(nms, 679, mkChar("offset_output_number_GetICU_NoOx"));
  SET_STRING_ELT(nms, 680, mkChar("offset_output_number_GetICU_NoOx_to_IMod"));
  SET_STRING_ELT(nms, 681, mkChar("offset_output_number_ICrit_GetICU_GetOx"));
  SET_STRING_ELT(nms, 682, mkChar("offset_output_number_ICrit_GetICU_GetOx_GetMV"));
  SET_STRING_ELT(nms, 683, mkChar("offset_output_number_ICrit_GetICU_GetOx_NoMV"));
  SET_STRING_ELT(nms, 684, mkChar("offset_output_number_ICrit_GetICU_NoOx_NoMV"));
  SET_STRING_ELT(nms, 685, mkChar("offset_output_number_ICrit_NoICU_NoOx_NoMV"));
  SET_STRING_ELT(nms, 686, mkChar("offset_output_number_IMod_GetHosp_GetOx"));
  SET_STRING_ELT(nms, 687, mkChar("offset_output_number_IMod_GetHosp_NoOx"));
  SET_STRING_ELT(nms, 688, mkChar("offset_output_number_IMod_NoHosp_NoOx"));
  SET_STRING_ELT(nms, 689, mkChar("offset_output_number_ISev_GetICU_GetOx"));
  SET_STRING_ELT(nms, 690, mkChar("offset_output_number_ISev_GetICU_NoOx"));
  SET_STRING_ELT(nms, 691, mkChar("offset_output_number_ISev_NoICU_NoOx"));
  SET_STRING_ELT(nms, 692, mkChar("offset_output_number_NoICU"));
  SET_STRING_ELT(nms, 693, mkChar("offset_output_number_req_Hosp"));
  SET_STRING_ELT(nms, 694, mkChar("offset_output_number_req_ICU"));
  SET_STRING_ELT(nms, 695, mkChar("offset_output_number_req_ICU_remaining"));
  SET_STRING_ELT(nms, 696, mkChar("offset_output_prob_critical_death_get_ICU_get_ox_get_MV"));
  SET_STRING_ELT(nms, 697, mkChar("offset_output_prob_critical_death_get_ICU_get_ox_get_MV_baseline"));
  SET_STRING_ELT(nms, 698, mkChar("offset_output_prob_critical_death_get_ICU_get_ox_get_MV_Drug_13"));
  SET_STRING_ELT(nms, 699, mkChar("offset_output_prob_critical_death_get_ICU_get_ox_no_MV"));
  SET_STRING_ELT(nms, 700, mkChar("offset_output_prob_critical_death_get_ICU_get_ox_no_MV_baseline"));
  SET_STRING_ELT(nms, 701, mkChar("offset_output_prob_critical_death_get_ICU_get_ox_no_MV_Drug_13"));
  SET_STRING_ELT(nms, 702, mkChar("offset_output_prob_critical_death_get_ICU_no_ox_no_MV"));
  SET_STRING_ELT(nms, 703, mkChar("offset_output_prob_critical_death_get_ICU_no_ox_no_MV_baseline"));
  SET_STRING_ELT(nms, 704, mkChar("offset_output_prob_critical_death_get_ICU_no_ox_no_MV_Drug_13"));
  SET_STRING_ELT(nms, 705, mkChar("offset_output_prob_moderate_death_get_hosp_get_ox"));
  SET_STRING_ELT(nms, 706, mkChar("offset_output_prob_moderate_death_get_hosp_get_ox_baseline"));
  SET_STRING_ELT(nms, 707, mkChar("offset_output_prob_moderate_death_get_hosp_get_ox_Drug_11"));
  SET_STRING_ELT(nms, 708, mkChar("offset_output_prob_moderate_death_get_hosp_no_ox"));
  SET_STRING_ELT(nms, 709, mkChar("offset_output_prob_moderate_death_get_hosp_no_ox_baseline"));
  SET_STRING_ELT(nms, 710, mkChar("offset_output_prob_moderate_death_get_hosp_no_ox_Drug_11"));
  SET_STRING_ELT(nms, 711, mkChar("offset_output_prob_severe_death_get_ICU_get_ox"));
  SET_STRING_ELT(nms, 712, mkChar("offset_output_prob_severe_death_get_ICU_get_ox_baseline"));
  SET_STRING_ELT(nms, 713, mkChar("offset_output_prob_severe_death_get_ICU_get_ox_Drug_12"));
  SET_STRING_ELT(nms, 714, mkChar("offset_output_prob_severe_death_get_ICU_no_ox"));
  SET_STRING_ELT(nms, 715, mkChar("offset_output_prob_severe_death_get_ICU_no_ox_baseline"));
  SET_STRING_ELT(nms, 716, mkChar("offset_output_prob_severe_death_get_ICU_no_ox_Drug_12"));
  SET_STRING_ELT(nms, 717, mkChar("offset_output_test_number_req_Hosp"));
  SET_STRING_ELT(nms, 718, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 719, mkChar("offset_variable_D_Community"));
  SET_STRING_ELT(nms, 720, mkChar("offset_variable_D_Hospital"));
  SET_STRING_ELT(nms, 721, mkChar("offset_variable_E2"));
  SET_STRING_ELT(nms, 722, mkChar("offset_variable_IAsymp"));
  SET_STRING_ELT(nms, 723, mkChar("offset_variable_ICase1"));
  SET_STRING_ELT(nms, 724, mkChar("offset_variable_ICase1Drug3"));
  SET_STRING_ELT(nms, 725, mkChar("offset_variable_ICase2"));
  SET_STRING_ELT(nms, 726, mkChar("offset_variable_ICase2Drug3"));
  SET_STRING_ELT(nms, 727, mkChar("offset_variable_ICrit_GetICU_GetOx_GetMV_Die1"));
  SET_STRING_ELT(nms, 728, mkChar("offset_variable_ICrit_GetICU_GetOx_GetMV_Die2"));
  SET_STRING_ELT(nms, 729, mkChar("offset_variable_ICrit_GetICU_GetOx_GetMV_Surv1"));
  SET_STRING_ELT(nms, 730, mkChar("offset_variable_ICrit_GetICU_GetOx_GetMV_Surv2"));
  SET_STRING_ELT(nms, 731, mkChar("offset_variable_ICrit_GetICU_GetOx_NoMV_Die1"));
  SET_STRING_ELT(nms, 732, mkChar("offset_variable_ICrit_GetICU_GetOx_NoMV_Die2"));
  SET_STRING_ELT(nms, 733, mkChar("offset_variable_ICrit_GetICU_GetOx_NoMV_Surv1"));
  SET_STRING_ELT(nms, 734, mkChar("offset_variable_ICrit_GetICU_GetOx_NoMV_Surv2"));
  SET_STRING_ELT(nms, 735, mkChar("offset_variable_ICrit_GetICU_NoOx_NoMV_Die1"));
  SET_STRING_ELT(nms, 736, mkChar("offset_variable_ICrit_GetICU_NoOx_NoMV_Die2"));
  SET_STRING_ELT(nms, 737, mkChar("offset_variable_ICrit_GetICU_NoOx_NoMV_Surv1"));
  SET_STRING_ELT(nms, 738, mkChar("offset_variable_ICrit_GetICU_NoOx_NoMV_Surv2"));
  SET_STRING_ELT(nms, 739, mkChar("offset_variable_ICrit_NoICU_NoOx_NoMV_Die1"));
  SET_STRING_ELT(nms, 740, mkChar("offset_variable_ICrit_NoICU_NoOx_NoMV_Die2"));
  SET_STRING_ELT(nms, 741, mkChar("offset_variable_ICrit_NoICU_NoOx_NoMV_Surv1"));
  SET_STRING_ELT(nms, 742, mkChar("offset_variable_ICrit_NoICU_NoOx_NoMV_Surv2"));
  SET_STRING_ELT(nms, 743, mkChar("offset_variable_IMild"));
  SET_STRING_ELT(nms, 744, mkChar("offset_variable_IMod_GetHosp_GetOx_Die1"));
  SET_STRING_ELT(nms, 745, mkChar("offset_variable_IMod_GetHosp_GetOx_Die2"));
  SET_STRING_ELT(nms, 746, mkChar("offset_variable_IMod_GetHosp_GetOx_Surv1"));
  SET_STRING_ELT(nms, 747, mkChar("offset_variable_IMod_GetHosp_GetOx_Surv2"));
  SET_STRING_ELT(nms, 748, mkChar("offset_variable_IMod_GetHosp_NoOx_Die1"));
  SET_STRING_ELT(nms, 749, mkChar("offset_variable_IMod_GetHosp_NoOx_Die2"));
  SET_STRING_ELT(nms, 750, mkChar("offset_variable_IMod_GetHosp_NoOx_Surv1"));
  SET_STRING_ELT(nms, 751, mkChar("offset_variable_IMod_GetHosp_NoOx_Surv2"));
  SET_STRING_ELT(nms, 752, mkChar("offset_variable_IMod_NoHosp_NoOx_Die1"));
  SET_STRING_ELT(nms, 753, mkChar("offset_variable_IMod_NoHosp_NoOx_Die2"));
  SET_STRING_ELT(nms, 754, mkChar("offset_variable_IMod_NoHosp_NoOx_Surv1"));
  SET_STRING_ELT(nms, 755, mkChar("offset_variable_IMod_NoHosp_NoOx_Surv2"));
  SET_STRING_ELT(nms, 756, mkChar("offset_variable_IPre1Asymp"));
  SET_STRING_ELT(nms, 757, mkChar("offset_variable_IPre1Case"));
  SET_STRING_ELT(nms, 758, mkChar("offset_variable_IPre1CaseDrug3"));
  SET_STRING_ELT(nms, 759, mkChar("offset_variable_IPre1Mild"));
  SET_STRING_ELT(nms, 760, mkChar("offset_variable_IPre2Asymp"));
  SET_STRING_ELT(nms, 761, mkChar("offset_variable_IPre2Case"));
  SET_STRING_ELT(nms, 762, mkChar("offset_variable_IPre2CaseDrug3"));
  SET_STRING_ELT(nms, 763, mkChar("offset_variable_IPre2Mild"));
  SET_STRING_ELT(nms, 764, mkChar("offset_variable_IRec1"));
  SET_STRING_ELT(nms, 765, mkChar("offset_variable_IRec2"));
  SET_STRING_ELT(nms, 766, mkChar("offset_variable_ISev_GetICU_GetOx_Die1"));
  SET_STRING_ELT(nms, 767, mkChar("offset_variable_ISev_GetICU_GetOx_Die2"));
  SET_STRING_ELT(nms, 768, mkChar("offset_variable_ISev_GetICU_GetOx_Surv1"));
  SET_STRING_ELT(nms, 769, mkChar("offset_variable_ISev_GetICU_GetOx_Surv2"));
  SET_STRING_ELT(nms, 770, mkChar("offset_variable_ISev_GetICU_NoOx_Die1"));
  SET_STRING_ELT(nms, 771, mkChar("offset_variable_ISev_GetICU_NoOx_Die2"));
  SET_STRING_ELT(nms, 772, mkChar("offset_variable_ISev_GetICU_NoOx_Surv1"));
  SET_STRING_ELT(nms, 773, mkChar("offset_variable_ISev_GetICU_NoOx_Surv2"));
  SET_STRING_ELT(nms, 774, mkChar("offset_variable_ISev_NoICU_NoOx_Die1"));
  SET_STRING_ELT(nms, 775, mkChar("offset_variable_ISev_NoICU_NoOx_Die2"));
  SET_STRING_ELT(nms, 776, mkChar("offset_variable_ISev_NoICU_NoOx_Surv1"));
  SET_STRING_ELT(nms, 777, mkChar("offset_variable_ISev_NoICU_NoOx_Surv2"));
  SET_STRING_ELT(nms, 778, mkChar("offset_variable_PE1"));
  SET_STRING_ELT(nms, 779, mkChar("offset_variable_PE2"));
  SET_STRING_ELT(nms, 780, mkChar("offset_variable_PS"));
  SET_STRING_ELT(nms, 781, mkChar("offset_variable_R"));
  SET_STRING_ELT(nms, 782, mkChar("PE1_0"));
  SET_STRING_ELT(nms, 783, mkChar("PE2_0"));
  SET_STRING_ELT(nms, 784, mkChar("prob_asymp"));
  SET_STRING_ELT(nms, 785, mkChar("prob_critical"));
  SET_STRING_ELT(nms, 786, mkChar("prob_critical_death_get_ICU_get_ox_get_MV"));
  SET_STRING_ELT(nms, 787, mkChar("prob_critical_death_get_ICU_get_ox_get_MV_baseline"));
  SET_STRING_ELT(nms, 788, mkChar("prob_critical_death_get_ICU_get_ox_get_MV_Drug_13"));
  SET_STRING_ELT(nms, 789, mkChar("prob_critical_death_get_ICU_get_ox_no_MV"));
  SET_STRING_ELT(nms, 790, mkChar("prob_critical_death_get_ICU_get_ox_no_MV_baseline"));
  SET_STRING_ELT(nms, 791, mkChar("prob_critical_death_get_ICU_get_ox_no_MV_Drug_13"));
  SET_STRING_ELT(nms, 792, mkChar("prob_critical_death_get_ICU_no_ox_no_MV"));
  SET_STRING_ELT(nms, 793, mkChar("prob_critical_death_get_ICU_no_ox_no_MV_baseline"));
  SET_STRING_ELT(nms, 794, mkChar("prob_critical_death_get_ICU_no_ox_no_MV_Drug_13"));
  SET_STRING_ELT(nms, 795, mkChar("prob_critical_death_no_ICU_no_ox_no_MV"));
  SET_STRING_ELT(nms, 796, mkChar("prob_hosp"));
  SET_STRING_ELT(nms, 797, mkChar("prob_moderate_death_get_hosp_get_ox"));
  SET_STRING_ELT(nms, 798, mkChar("prob_moderate_death_get_hosp_get_ox_baseline"));
  SET_STRING_ELT(nms, 799, mkChar("prob_moderate_death_get_hosp_get_ox_Drug_11"));
  SET_STRING_ELT(nms, 800, mkChar("prob_moderate_death_get_hosp_no_ox"));
  SET_STRING_ELT(nms, 801, mkChar("prob_moderate_death_get_hosp_no_ox_baseline"));
  SET_STRING_ELT(nms, 802, mkChar("prob_moderate_death_get_hosp_no_ox_Drug_11"));
  SET_STRING_ELT(nms, 803, mkChar("prob_moderate_death_no_hosp_no_ox"));
  SET_STRING_ELT(nms, 804, mkChar("prob_severe"));
  SET_STRING_ELT(nms, 805, mkChar("prob_severe_death_get_ICU_get_ox"));
  SET_STRING_ELT(nms, 806, mkChar("prob_severe_death_get_ICU_get_ox_baseline"));
  SET_STRING_ELT(nms, 807, mkChar("prob_severe_death_get_ICU_get_ox_Drug_12"));
  SET_STRING_ELT(nms, 808, mkChar("prob_severe_death_get_ICU_no_ox"));
  SET_STRING_ELT(nms, 809, mkChar("prob_severe_death_get_ICU_no_ox_baseline"));
  SET_STRING_ELT(nms, 810, mkChar("prob_severe_death_get_ICU_no_ox_Drug_12"));
  SET_STRING_ELT(nms, 811, mkChar("prob_severe_death_no_ICU_no_ox"));
  SET_STRING_ELT(nms, 812, mkChar("prop_ox_hosp_beds"));
  SET_STRING_ELT(nms, 813, mkChar("prop_ox_ICU_beds"));
  SET_STRING_ELT(nms, 814, mkChar("prophylactic_drug_timing_1"));
  SET_STRING_ELT(nms, 815, mkChar("prophylactic_drug_timing_2"));
  SET_STRING_ELT(nms, 816, mkChar("prophylactic_drug_wane"));
  SET_STRING_ELT(nms, 817, mkChar("prophylactic_prop_treat"));
  SET_STRING_ELT(nms, 818, mkChar("PS_0"));
  SET_STRING_ELT(nms, 819, mkChar("R_0"));
  SET_STRING_ELT(nms, 820, mkChar("rel_inf_asymp"));
  SET_STRING_ELT(nms, 821, mkChar("rel_inf_mild"));
  SET_STRING_ELT(nms, 822, mkChar("S_0"));
  SET_STRING_ELT(nms, 823, mkChar("s_ij"));
  SET_STRING_ELT(nms, 824, mkChar("temp"));
  SET_STRING_ELT(nms, 825, mkChar("test_number_req_Hosp"));
  SET_STRING_ELT(nms, 826, mkChar("tt_beta"));
  SET_STRING_ELT(nms, 827, mkChar("tt_hosp_beds"));
  SET_STRING_ELT(nms, 828, mkChar("tt_ICU_beds"));
  SET_STRING_ELT(nms, 829, mkChar("tt_matrix"));
  SET_STRING_ELT(nms, 830, mkChar("tt_prop_ox_hosp_beds"));
  SET_STRING_ELT(nms, 831, mkChar("tt_prop_ox_ICU_beds"));
...
SEXP deterministic_apothecary_SEIR_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_output_n_E2_IPre = 61 + internal->dim_n_E2_IPre1ICaseDrug3 + internal->dim_n_E2_IPre1ICase + internal->dim_test_number_req_Hosp + internal->dim_n_ICase2_Hosp + internal->dim_number_NoICU;
  internal->offset_output_n_E2_IPre1ICase = 61 + internal->dim_n_E2_IPre1ICaseDrug3;
  internal->offset_output_n_ICase2_Hosp = 61 + internal->dim_n_E2_IPre1ICaseDrug3 + internal->dim_n_E2_IPre1ICase + internal->dim_test_number_req_Hosp;
  internal->offset_output_n_ICrit_GetICU_GetOx_GetMV_Surv1 = 61 + internal->dim_n_E2_IPre1ICaseDrug3 + internal->dim_n_E2_IPre1ICase + internal->dim_test_number_req_Hosp + internal->dim_n_ICase2_Hosp + internal->dim_number_NoICU + internal->dim_n_E2_IPre + internal->dim_n_IMod_GetHosp_GetOx_Die1 + internal->dim_n_IMod_GetHosp_NoOx_Die1 + internal->dim_n_IMod_NoHosp_NoOx_Die1 + internal->dim_n_S_PS + internal->dim_n_PS_PE1 + internal->dim_n_PS_S + internal->dim_n_PE1_PE2 + internal->dim_number_ICrit_GetICU_GetOx + internal->dim_n_ISev_GetICU_GetOx_Die1 + internal->dim_n_ISev_GetICU_GetOx_Surv1 + internal->dim_n_ISev_GetICU_GetOx_Surv1_ISev_GetICU_GetOx_Surv2 + internal->dim_n_IMod_GetHosp_GetOx_Surv2_R + internal->dim_n_IMod_GetHosp_NoOx_Surv2_R + internal->dim_n_ISev_GetICU_GetOx_Surv2_Rec + internal->dim_n_ISev_GetICU_NoOx_Surv2_Rec + internal->dim_n_ICrit_GetICU_GetOx_GetMV_Surv2_Rec + internal->dim_n_ICrit_GetICU_GetOx_NoMV_Surv2_Rec + internal->dim_n_ICrit_GetICU_NoOx_NoMV_Surv2_Rec;
  ...
  internal->offset_output_n_IMod_GetHosp_GetOx_Die1 = 61 + internal->dim_n_E2_IPre1ICaseDrug3 + internal->dim_n_E2_IPre1ICase + internal->dim_test_number_req_Hosp + internal->dim_n_ICase2_Hosp + internal->dim_number_NoICU + internal->dim_n_E2_IPre;
  ...
  internal->offset_output_n_IMod_GetHosp_NoOx_Die1 = 61 + internal->dim_n_E2_IPre1ICaseDrug3 + internal->dim_n_E2_IPre1ICase + internal->dim_test_number_req_Hosp + internal->dim_n_ICase2_Hosp + internal->dim_number_NoICU + internal->dim_n_E2_IPre + internal->dim_n_IMod_GetHosp_GetOx_Die1;
  internal->offset_output_n_IMod_GetHosp_NoOx_Surv2_R = 61 + internal->dim_n_E2_IPre1ICaseDrug3 + internal->dim_n_E2_IPre1ICase + internal->dim_test_number_req_Hosp + internal->dim_n_ICase2_Hosp + internal->dim_number_NoICU + internal->dim_n_E2_IPre + internal->dim_n_IMod_GetHosp_GetOx_Die1 + internal->dim_n_IMod_GetHosp_NoOx_Die1 + internal->dim_n_IMod_NoHosp_NoOx_Die1 + internal->dim_n_S_PS + internal->dim_n_PS_PE1 + internal->dim_n_PS_S + internal->dim_n_PE1_PE2 + internal->dim_number_ICrit_GetICU_GetOx + internal->dim_n_ISev_GetICU_GetOx_Die1 + internal->dim_n_ISev_GetICU_GetOx_Surv1 + internal->dim_n_ISev_GetICU_GetOx_Surv1_ISev_GetICU_GetOx_Surv2 + internal->dim_n_IMod_GetHosp_GetOx_Surv2_R;
  internal->offset_output_n_IMod_NoHosp_NoOx_Die1 = 61 + internal->dim_n_E2_IPre1ICaseDrug3 + internal->dim_n_E2_IPre1ICase + internal->dim_test_number_req_Hosp + internal->dim_n_ICase2_Hosp + internal->dim_number_NoICU + internal->dim_n_E2_IPre + internal->dim_n_IMod_GetHosp_GetOx_Die1 + internal->dim_n_IMod_GetHosp_NoOx_Die1;
  ...
  internal->offset_output_number_NoICU = 61 + internal->dim_n_E2_IPre1ICaseDrug3 + internal->dim_n_E2_IPre1ICase + internal->dim_test_number_req_Hosp + internal->dim_n_ICase2_Hosp;
  ...
  internal->offset_output_test_number_req_Hosp = 61 + internal->dim_n_E2_IPre1ICaseDrug3 + internal->dim_n_E2_IPre1ICase;
...
SEXP deterministic_apothecary_SEIR_metadata(SEXP internal_p) {
  ...
  UNPROTECT(2);
  SEXP output_length = PROTECT(allocVector(VECSXP, 128));
  SEXP output_names = PROTECT(allocVector(STRSXP, 128));
  ...
  SET_VECTOR_ELT(output_length, 61, ScalarInteger(internal->dim_n_E2_IPre1ICaseDrug3));
  SET_VECTOR_ELT(output_length, 62, ScalarInteger(internal->dim_n_E2_IPre1ICase));
  SET_VECTOR_ELT(output_length, 63, ScalarInteger(internal->dim_test_number_req_Hosp));
  SET_VECTOR_ELT(output_length, 64, ScalarInteger(internal->dim_n_ICase2_Hosp));
  SET_VECTOR_ELT(output_length, 65, ScalarInteger(internal->dim_number_NoICU));
  SET_VECTOR_ELT(output_length, 66, ScalarInteger(internal->dim_n_E2_IPre));
  SET_VECTOR_ELT(output_length, 67, ScalarInteger(internal->dim_n_IMod_GetHosp_GetOx_Die1));
  SET_VECTOR_ELT(output_length, 68, ScalarInteger(internal->dim_n_IMod_GetHosp_NoOx_Die1));
  SET_VECTOR_ELT(output_length, 69, ScalarInteger(internal->dim_n_IMod_NoHosp_NoOx_Die1));
  SET_VECTOR_ELT(output_length, 70, ScalarInteger(internal->dim_n_S_PS));
  SET_VECTOR_ELT(output_length, 71, ScalarInteger(internal->dim_n_PS_PE1));
  SET_VECTOR_ELT(output_length, 72, ScalarInteger(internal->dim_n_PS_S));
  SET_VECTOR_ELT(output_length, 73, ScalarInteger(internal->dim_n_PE1_PE2));
  SET_VECTOR_ELT(output_length, 74, ScalarInteger(internal->dim_number_ICrit_GetICU_GetOx));
  SET_VECTOR_ELT(output_length, 75, ScalarInteger(internal->dim_n_ISev_GetICU_GetOx_Die1));
  SET_VECTOR_ELT(output_length, 76, ScalarInteger(internal->dim_n_ISev_GetICU_GetOx_Surv1));
  SET_VECTOR_ELT(output_length, 77, ScalarInteger(internal->dim_n_ISev_GetICU_GetOx_Surv1_ISev_GetICU_GetOx_Surv2));
  SET_VECTOR_ELT(output_length, 78, ScalarInteger(internal->dim_n_IMod_GetHosp_GetOx_Surv2_R));
  SET_VECTOR_ELT(output_length, 79, ScalarInteger(internal->dim_n_IMod_GetHosp_NoOx_Surv2_R));
  SET_VECTOR_ELT(output_length, 80, ScalarInteger(internal->dim_n_ISev_GetICU_GetOx_Surv2_Rec));
  SET_VECTOR_ELT(output_length, 81, ScalarInteger(internal->dim_n_ISev_GetICU_NoOx_Surv2_Rec));
  SET_VECTOR_ELT(output_length, 82, ScalarInteger(internal->dim_n_ICrit_GetICU_GetOx_GetMV_Surv2_Rec));
  SET_VECTOR_ELT(output_length, 83, ScalarInteger(internal->dim_n_ICrit_GetICU_GetOx_NoMV_Surv2_Rec));
  SET_VECTOR_ELT(output_length, 84, ScalarInteger(internal->dim_n_ICrit_GetICU_NoOx_NoMV_Surv2_Rec));
  SET_VECTOR_ELT(output_length, 85, ScalarInteger(internal->dim_n_ICrit_GetICU_GetOx_GetMV_Surv1));
  SET_VECTOR_ELT(output_length, 86, ScalarInteger(internal->dim_n_ICrit_GetICU_GetOx_GetMV_Surv1_ICrit_GetICU_GetOx_GetMV_Surv2));
  SET_VECTOR_ELT(output_length, 87, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_get_ox_baseline));
  SET_VECTOR_ELT(output_length, 88, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_get_ox_Drug_11));
  SET_VECTOR_ELT(output_length, 89, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_get_ox));
  SET_VECTOR_ELT(output_length, 90, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_no_ox_baseline));
  SET_VECTOR_ELT(output_length, 91, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_no_ox_Drug_11));
  SET_VECTOR_ELT(output_length, 92, ScalarInteger(internal->dim_prob_moderate_death_get_hosp_no_ox));
  SET_VECTOR_ELT(output_length, 93, ScalarInteger(internal->dim_prob_severe_death_get_ICU_get_ox_baseline));
  SET_VECTOR_ELT(output_length, 94, ScalarInteger(internal->dim_prob_severe_death_get_ICU_get_ox_Drug_12));
  SET_VECTOR_ELT(output_length, 95, ScalarInteger(internal->dim_prob_severe_death_get_ICU_get_ox));
  SET_VECTOR_ELT(output_length, 96, ScalarInteger(internal->dim_prob_severe_death_get_ICU_no_ox_baseline));
  SET_VECTOR_ELT(output_length, 97, ScalarInteger(internal->dim_prob_severe_death_get_ICU_no_ox_Drug_12));
  SET_VECTOR_ELT(output_length, 98, ScalarInteger(internal->dim_prob_severe_death_get_ICU_no_ox));
  SET_VECTOR_ELT(output_length, 99, ScalarInteger(internal->dim_prob_critical_death_get_ICU_get_ox_get_MV_baseline));
  SET_VECTOR_ELT(output_length, 100, ScalarInteger(internal->dim_prob_critical_death_get_ICU_get_ox_get_MV_Drug_13));
  SET_VECTOR_ELT(output_length, 101, ScalarInteger(internal->dim_prob_critical_death_get_ICU_get_ox_get_MV));
  SET_VECTOR_ELT(output_length, 102, ScalarInteger(internal->dim_prob_critical_death_get_ICU_get_ox_no_MV_baseline));
  SET_VECTOR_ELT(output_length, 103, ScalarInteger(internal->dim_prob_critical_death_get_ICU_get_ox_no_MV_Drug_13));
  SET_VECTOR_ELT(output_length, 104, ScalarInteger(internal->dim_prob_critical_death_get_ICU_get_ox_no_MV));
  SET_VECTOR_ELT(output_length, 105, ScalarInteger(internal->dim_prob_critical_death_get_ICU_no_ox_no_MV_baseline));
  SET_VECTOR_ELT(output_length, 106, ScalarInteger(internal->dim_prob_critical_death_get_ICU_no_ox_no_MV_Drug_13));
  SET_VECTOR_ELT(output_length, 107, ScalarInteger(internal->dim_prob_critical_death_get_ICU_no_ox_no_MV));
  SET_VECTOR_ELT(output_length, 108, ScalarInteger(internal->dim_number_req_Hosp));
  SET_VECTOR_ELT(output_length, 109, ScalarInteger(internal->dim_n_IMod_GetHosp_GetOx_Die2_D_Hospital));
  SET_VECTOR_ELT(output_length, 110, ScalarInteger(internal->dim_number_IMod_GetHosp_GetOx));
  SET_VECTOR_ELT(output_length, 111, ScalarInteger(internal->dim_number_IMod_GetHosp_NoOx));
  SET_VECTOR_ELT(output_length, 112, ScalarInteger(internal->dim_number_IMod_NoHosp_NoOx));
  SET_VECTOR_ELT(output_length, 113, ScalarInteger(internal->dim_number_ISev_GetICU_GetOx));
  SET_VECTOR_ELT(output_length, 114, ScalarInteger(internal->dim_number_ISev_GetICU_NoOx));
  SET_VECTOR_ELT(output_length, 115, ScalarInteger(internal->dim_number_ISev_NoICU_NoOx));
  SET_VECTOR_ELT(output_length, 116, ScalarInteger(internal->dim_number_ICrit_GetICU_GetOx_GetMV));
  SET_VECTOR_ELT(output_length, 117, ScalarInteger(internal->dim_number_ICrit_GetICU_GetOx_NoMV));
  SET_VECTOR_ELT(output_length, 118, ScalarInteger(internal->dim_number_ICrit_GetICU_NoOx_NoMV));
  SET_VECTOR_ELT(output_length, 119, ScalarInteger(internal->dim_number_ICrit_NoICU_NoOx_NoMV));
  SET_VECTOR_ELT(output_length, 120, ScalarInteger(internal->dim_number_req_ICU));
  SET_VECTOR_ELT(output_length, 121, ScalarInteger(internal->dim_n_ISev_GetICU_NoOx_Die2_D_Hospital));
  SET_VECTOR_ELT(output_length, 122, ScalarInteger(internal->dim_n_ICrit_GetICU_NoOx_NoMV_Die2_D_Hospital));
  SET_VECTOR_ELT(output_length, 123, ScalarInteger(internal->dim_number_GetICU_GetOx_to_IMod));
  SET_VECTOR_ELT(output_length, 124, ScalarInteger(internal->dim_number_GetICU_GetOx));
  SET_VECTOR_ELT(output_length, 125, ScalarInteger(internal->dim_number_req_ICU_remaining));
  SET_VECTOR_ELT(output_length, 126, ScalarInteger(internal->dim_number_GetICU_NoOx_to_IMod));
  SET_VECTOR_ELT(output_length, 127, ScalarInteger(internal->dim_number_GetICU_NoOx));
  ...
  SET_STRING_ELT(output_names, 61, mkChar("n_E2_IPre1ICaseDrug3"));
  SET_STRING_ELT(output_names, 62, mkChar("n_E2_IPre1ICase"));
  SET_STRING_ELT(output_names, 63, mkChar("test_number_req_Hosp"));
  SET_STRING_ELT(output_names, 64, mkChar("n_ICase2_Hosp"));
  SET_STRING_ELT(output_names, 65, mkChar("number_NoICU"));
  SET_STRING_ELT(output_names, 66, mkChar("n_E2_IPre"));
  SET_STRING_ELT(output_names, 67, mkChar("n_IMod_GetHosp_GetOx_Die1"));
  SET_STRING_ELT(output_names, 68, mkChar("n_IMod_GetHosp_NoOx_Die1"));
  SET_STRING_ELT(output_names, 69, mkChar("n_IMod_NoHosp_NoOx_Die1"));
  SET_STRING_ELT(output_names, 70, mkChar("n_S_PS"));
  SET_STRING_ELT(output_names, 71, mkChar("n_PS_PE1"));
  SET_STRING_ELT(output_names, 72, mkChar("n_PS_S"));
  SET_STRING_ELT(output_names, 73, mkChar("n_PE1_PE2"));
  SET_STRING_ELT(output_names, 74, mkChar("number_ICrit_GetICU_GetOx"));
  SET_STRING_ELT(output_names, 75, mkChar("n_ISev_GetICU_GetOx_Die1"));
  SET_STRING_ELT(output_names, 76, mkChar("n_ISev_GetICU_GetOx_Surv1"));
  SET_STRING_ELT(output_names, 77, mkChar("n_ISev_GetICU_GetOx_Surv1_ISev_GetICU_GetOx_Surv2"));
  SET_STRING_ELT(output_names, 78, mkChar("n_IMod_GetHosp_GetOx_Surv2_R"));
  SET_STRING_ELT(output_names, 79, mkChar("n_IMod_GetHosp_NoOx_Surv2_R"));
  SET_STRING_ELT(output_names, 80, mkChar("n_ISev_GetICU_GetOx_Surv2_Rec"));
  SET_STRING_ELT(output_names, 81, mkChar("n_ISev_GetICU_NoOx_Surv2_Rec"));
  SET_STRING_ELT(output_names, 82, mkChar("n_ICrit_GetICU_GetOx_GetMV_Surv2_Rec"));
  SET_STRING_ELT(output_names, 83, mkChar("n_ICrit_GetICU_GetOx_NoMV_Surv2_Rec"));
  SET_STRING_ELT(output_names, 84, mkChar("n_ICrit_GetICU_NoOx_NoMV_Surv2_Rec"));
  SET_STRING_ELT(output_names, 85, mkChar("n_ICrit_GetICU_GetOx_GetMV_Surv1"));
  SET_STRING_ELT(output_names, 86, mkChar("n_ICrit_GetICU_GetOx_GetMV_Surv1_ICrit_GetICU_GetOx_GetMV_Surv2"));
  SET_STRING_ELT(output_names, 87, mkChar("prob_moderate_death_get_hosp_get_ox_baseline"));
  SET_STRING_ELT(output_names, 88, mkChar("prob_moderate_death_get_hosp_get_ox_Drug_11"));
  SET_STRING_ELT(output_names, 89, mkChar("prob_moderate_death_get_hosp_get_ox"));
  SET_STRING_ELT(output_names, 90, mkChar("prob_moderate_death_get_hosp_no_ox_baseline"));
  SET_STRING_ELT(output_names, 91, mkChar("prob_moderate_death_get_hosp_no_ox_Drug_11"));
  SET_STRING_ELT(output_names, 92, mkChar("prob_moderate_death_get_hosp_no_ox"));
  SET_STRING_ELT(output_names, 93, mkChar("prob_severe_death_get_ICU_get_ox_baseline"));
  SET_STRING_ELT(output_names, 94, mkChar("prob_severe_death_get_ICU_get_ox_Drug_12"));
  SET_STRING_ELT(output_names, 95, mkChar("prob_severe_death_get_ICU_get_ox"));
  SET_STRING_ELT(output_names, 96, mkChar("prob_severe_death_get_ICU_no_ox_baseline"));
  SET_STRING_ELT(output_names, 97, mkChar("prob_severe_death_get_ICU_no_ox_Drug_12"));
  SET_STRING_ELT(output_names, 98, mkChar("prob_severe_death_get_ICU_no_ox"));
  SET_STRING_ELT(output_names, 99, mkChar("prob_critical_death_get_ICU_get_ox_get_MV_baseline"));
  SET_STRING_ELT(output_names, 100, mkChar("prob_critical_death_get_ICU_get_ox_get_MV_Drug_13"));
  SET_STRING_ELT(output_names, 101, mkChar("prob_critical_death_get_ICU_get_ox_get_MV"));
  SET_STRING_ELT(output_names, 102, mkChar("prob_critical_death_get_ICU_get_ox_no_MV_baseline"));
  SET_STRING_ELT(output_names, 103, mkChar("prob_critical_death_get_ICU_get_ox_no_MV_Drug_13"));
  SET_STRING_ELT(output_names, 104, mkChar("prob_critical_death_get_ICU_get_ox_no_MV"));
  SET_STRING_ELT(output_names, 105, mkChar("prob_critical_death_get_ICU_no_ox_no_MV_baseline"));
  SET_STRING_ELT(output_names, 106, mkChar("prob_critical_death_get_ICU_no_ox_no_MV_Drug_13"));
  SET_STRING_ELT(output_names, 107, mkChar("prob_critical_death_get_ICU_no_ox_no_MV"));
  SET_STRING_ELT(output_names, 108, mkChar("number_req_Hosp"));
  SET_STRING_ELT(output_names, 109, mkChar("n_IMod_GetHosp_GetOx_Die2_D_Hospital"));
  SET_STRING_ELT(output_names, 110, mkChar("number_IMod_GetHosp_GetOx"));
  SET_STRING_ELT(output_names, 111, mkChar("number_IMod_GetHosp_NoOx"));
  SET_STRING_ELT(output_names, 112, mkChar("number_IMod_NoHosp_NoOx"));
  SET_STRING_ELT(output_names, 113, mkChar("number_ISev_GetICU_GetOx"));
  SET_STRING_ELT(output_names, 114, mkChar("number_ISev_GetICU_NoOx"));
  SET_STRING_ELT(output_names, 115, mkChar("number_ISev_NoICU_NoOx"));
  SET_STRING_ELT(output_names, 116, mkChar("number_ICrit_GetICU_GetOx_GetMV"));
  SET_STRING_ELT(output_names, 117, mkChar("number_ICrit_GetICU_GetOx_NoMV"));
  SET_STRING_ELT(output_names, 118, mkChar("number_ICrit_GetICU_NoOx_NoMV"));
  SET_STRING_ELT(output_names, 119, mkChar("number_ICrit_NoICU_NoOx_NoMV"));
  SET_STRING_ELT(output_names, 120, mkChar("number_req_ICU"));
  SET_STRING_ELT(output_names, 121, mkChar("n_ISev_GetICU_NoOx_Die2_D_Hospital"));
  SET_STRING_ELT(output_names, 122, mkChar("n_ICrit_GetICU_NoOx_NoMV_Die2_D_Hospital"));
  SET_STRING_ELT(output_names, 123, mkChar("number_GetICU_GetOx_to_IMod"));
  SET_STRING_ELT(output_names, 124, mkChar("number_GetICU_GetOx"));
  SET_STRING_ELT(output_names, 125, mkChar("number_req_ICU_remaining"));
  SET_STRING_ELT(output_names, 126, mkChar("number_GetICU_NoOx_to_IMod"));
  SET_STRING_ELT(output_names, 127, mkChar("number_GetICU_NoOx"));
...
void deterministic_apothecary_SEIR_rhs(deterministic_apothecary_SEIR_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  if (output) {
    ...
    memcpy(output + 61, internal->n_E2_IPre1ICaseDrug3, internal->dim_n_E2_IPre1ICaseDrug3 * sizeof(double));
