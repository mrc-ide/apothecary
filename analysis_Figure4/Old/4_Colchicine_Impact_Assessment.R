...
drug_df <- data.frame(drug = "colchicine", R0 = R, total_infected = drug_infected, attack_rate = drug_AR,
                      ...
                      doses = drug_doses)
saveRDS(drug_df, file = paste0("analysis_Figure4/Outputs/colchicine_", R, "_df.rds"))
