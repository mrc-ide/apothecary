...
dexy_hosp_full_receive <- calc_receipt_healthare(dexy, "hospital_full")
dexy_hosp_any_receive <- calc_receipt_healthare(dexy, "hospital_any")
dexy_ICU_full_receive <- calc_receipt_healthare(dexy, "ICU_full")
dexy_ICU_any_receive <- calc_receipt_healthare(dexy, "ICU_any")
...
dexy_hosp_full_days_capacity <- days_over_capacity(dexy, "hospital_full")
dexy_hosp_any_days_capacity <- days_over_capacity(dexy, "hospital_any")
dexy_ICU_full_days_capacity <- days_over_capacity(dexy, "ICU_full")
dexy_ICU_any_days_capacity <- days_over_capacity(dexy, "ICU_any")
