...
sum(rem$output[, index$number_IMod_NoHosp_NoOx]) - sum(none$output[, index$number_IMod_NoHosp_NoOx])
sum(rem$output[, index$number_IMod_GetHosp_NoOx]) - sum(none$output[, index$number_IMod_GetHosp_NoOx])
sum(rem$output[, index$number_IMod_GetHosp_GetOx]) - sum(none$output[, index$number_IMod_GetHosp_GetOx])
...
alt_IMod_D_avert_none_to_full_incr_hc <- sum(num_IMod_not_in_nothing * prob_IMod_death_none) - sum(num_IMod_not_in_nothing * prob_IMod_death_full)
alt_IMod_D_avert_inc_to_full_incr_hc <- sum(num_IMod_not_in_inc * prob_IMod_death_inc) - sum(num_IMod_not_in_inc * prob_IMod_death_full)
alt_IMod_D_avert_none_to_full_incr_hc + alt_IMod_D_avert_inc_to_full_incr_hc
...
alt2_IMod_D_avert_none_to_inc_incr_hc <- sum(num_IMod_not_in_nothing * prob_IMod_death_none) - sum(num_IMod_not_in_nothing * prob_IMod_death_inc)
alt2_IMod_D_avert_inc_to_full_incr_hc <- sum((num_IMod_not_in_inc + num_IMod_not_in_nothing) * prob_IMod_death_inc) - sum((num_IMod_not_in_inc + num_IMod_not_in_nothing) * prob_IMod_death_full)
alt2_IMod_D_avert_none_to_inc_incr_hc + alt2_IMod_D_avert_inc_to_full_incr_hc
