...
deterministic_apothecary_SEIR_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("beta_set", "D_Community_0", "D_Hospital_0",
             ...
             "drug_11_indic_IMod_GetHosp_NoOx",
             "drug_11_indic_IMod_NoHosp_NoOx", "drug_11_NoHosp_effect_size",
             "drug_11_NoOx_effect_size", "drug_11_prop_treat",
             "drug_12_GetOx_effect_size", "drug_12_indic_ISev_GetICU_GetOx",
             "drug_12_indic_ISev_GetICU_NoOx",
             "drug_12_indic_ISev_NoICU_NoOx", "drug_12_NoICU_effect_size",
             "drug_12_NoOx_effect_size", "drug_12_prop_treat",
             "drug_13_GetOx_GetMV_effect_size",
             ...
             "drug_13_indic_ICrit_NoICU_NoOx_NoMV",
             "drug_13_NoICU_effect_size", "drug_13_NoOx_NoMV_effect_size",
             "drug_13_prop_treat", "drug_2_effect_size_IPreAsymp",
             "drug_2_effect_size_IPreCase", "drug_2_effect_size_IPreMild",
             "drug_2_indic_IPreAsymp", "drug_2_indic_IPreCase",
             "drug_2_indic_IPreMild", "drug_2_prop_treat",
             "drug_3_effect_size", "drug_3_indic", "drug_3_prop_treat",
             "drug_4_effect_size_IAsymp", "drug_4_effect_size_ICase",
             "drug_4_effect_size_IMild", "drug_4_indic_IAsymp",
             "drug_4_indic_ICase", "drug_4_indic_IMild", "drug_4_prop_treat",
             "drug_5_effect_size", "drug_5_indic_ICase",
             "drug_5_indic_IMild", "drug_5_prop_treat", "drug_6_effect_size",
             "drug_6_indic", "drug_6_prop_treat", "drug_7_effect_size",
             "drug_7_indic", "drug_7_prop_treat", "drug_8_GetOx_effect_size",
             "drug_8_indic_IMod_GetHosp_GetOx",
             ...
             "prob_critical_death_no_ICU_no_ox_no_MV_baseline", "prob_hosp",
             "prob_moderate_death_get_hosp_get_ox_baseline",
             "prob_moderate_death_get_hosp_no_ox_baseline",
             "prob_moderate_death_no_hosp_no_ox_baseline", "prob_severe",
             "prob_severe_death_get_ICU_get_ox_baseline",
             "prob_severe_death_get_ICU_no_ox_baseline",
             "prob_severe_death_no_ICU_no_ox_baseline", "prop_ox_hosp_beds",
